! function(t) {
    ...
    0: function(t, e, n) {
        ...
        o.getFilter(i), i.transition("fade", {
            ...
            s.view = t, s.tab = e
        }), r.init("factory"), i.config.debug = !0
    },
    2: function(t, e, n) {
        var i = n(189),
            o = i.extend;
        ...
        ! function(e, n) {
            ...
            var lt = function(t) {
                function e(t, e, n, i) {
                    ...
                    if ((e ? e.ownerDocument || e : q) !== O && $(e), e = e || O, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return n;
                    if (!i && I) {
                        if (11 !== a && (o = bt.exec(t)))
                            if (s = o[1]) {
                                if (9 === a) {
                ...
                var y, w, x, C, k, S, A, E, T, D, N, $, O, j, I, F, P, L, R, M = "sizzle" + 1 * new Date,
                    q = t.document,
                    H = 0,
                    V = 0,
                    z = n(),
                ...
                w = e.support = {}, k = e.isXML = function(t) {
                    ...
                    return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, j = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), I = !k(i), w.attributes = o(function(t) {
                        ...
                        return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === q && R(q, t) ? -1 : e === i || e.ownerDocument === q && R(q, e) ? 1 : D ? tt(D, t) - tt(D, e) : 0 : 4 & n ? -1 : 1)
                    } : function(t, e) {
                        if (t === e) return N = !0, 0;
                        var n, o = 0,
                            r = t.parentNode,
                    ...
                    var e, n = [],
                        i = 0,
                        o = 0;
                    if (N = !w.detectDuplicates, D = !w.sortStable && t.slice(0), t.sort(U), N) {
                            ...
                            return 1 === i && 0 === o ? function(t) {
                                ...
                                if (v) {
                                    ...
                                    if (p = [s ? v.firstChild : v.lastChild], s && b) {
                                        for (u = v[M] || (v[M] = {}), c = u[t] || [], f = c[0] === H && c[1], h = c[0] === H && c[2], d = f && v.childNodes[f]; d = ++f && d && d[g] || (h = f = 0) || p.pop();)
                                            if (1 === d.nodeType && ++h && d === e) {
                                                u[t] = [H, f, h];
                                                break
                                            }
                                    } else if (b && (c = (e[M] || (e[M] = {}))[t]) && c[0] === H) h = c[1];
                                    else
                                        for (;
                                            (d = ++f && d && d[g] || (h = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++h || (b && ((d[M] || (d[M] = {}))[t] = [H, h]), d !== e)););
                ...
                }, w.sortStable = M.split("").sort(U).join("") === M, w.detectDuplicates = !!N, $(), w.sortDetached = o(function(t) {
            ...
            it.event = {
                ...
                fix: function(t) {
                    ...
                    var e, n, i, o = t.type,
                        r = t,
                        s = this.fixHooks[o];
                    for (s || (this.fixHooks[o] = s = $t.test(o) ? this.mouseHooks : Nt.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new it.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
            ...
            Vt.optgroup = Vt.option, Vt.tbody = Vt.tfoot = Vt.colgroup = Vt.caption = Vt.thead, Vt.th = Vt.td, it.extend({
                ...
                domManip: function(t, e) {
                    ...
                    if (c && (n = it.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                        ...
                        if (r)
                            for (a = o[o.length - 1].ownerDocument, it.map(o, b), l = 0; r > l; l++) s = o[l], Mt.test(s.type || "") && !wt.access(s, "globalEval") && it.contains(a, s) && (s.src ? it._evalUrl && it._evalUrl(s.src) : it.globalEval(s.textContent.replace(Ht, "")))
                    }
                    return this
                }
            }), it.each({
            ...
            it.extend({
                ...
                it.cssHooks[e] = {
                    ...
                    set: function(t, n, i) {
                        var o = i && Jt(t);
                        return T(t, n, i ? D(t, e, i, "border-box" === it.css(t, "boxSizing", !1, o), o) : 0)
                    }
                }
            ...
            it.fn.extend({
                ...
                toggleClass: function(t, e) {
                    ...
                    return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(it.isFunction(t) ? function(n) {
                        ...
                        else(n === Dt || "boolean" === n) && (this.className && wt.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : wt.get(this, "__className__") || "")
                    })
                },
                hasClass: function(t) {
            ...
            it.extend({
                ...
                ajax: function(t, e) {
                    ...
                    if (p.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Se) + "").replace(ge, "").replace(ye, Ae[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(mt) || [""], null == d.crossDomain && (l = we.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === Ae[1] && l[2] === Ae[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Ae[3] || ("http:" === Ae[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), q(xe, d, e, w), 2 === _) return w;
            ...
            it.param = function(t, e) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var t = this.type;
                        return this.name && !it(this).is(":disabled") && $e.test(this.nodeName) && !Ne.test(t) && (this.checked || !Tt.test(t))
                    }).map(function(t, e) {
                        var n = it(this).val();
            ...
            it.offset = {
                ...
                offset: function(t) {
                    ...
                    var e, n, i = this[0],
                        ...
                        r = i && i.ownerDocument;
                    return r ? (e = r.documentElement, it.contains(e, i) ? (typeof i.getBoundingClientRect !== Dt && (o = i.getBoundingClientRect()), n = B(r), {
    ...
    134: function(t, e) {
        (function() {
            window.Modernizr = function(t, e, n) {
                ...
                function u() {
                    p.input = function(n) {
                        for (var i = 0, o = n.length; o > i; i++) N[n[i]] = !!(n[i] in y);
    ...
    149: function(t, e, n) {
        ...
        function g(t, e) {
            ...
            for (var n, i, o = 0, r = N.length; o < r; o++)
                if (i = N[o], null !== (n = x.attr(t, i))) return m(t, i, n, e)
        }
                    ...
                    x = {
                        ...
                        setup: {
                            ...
                            select: function() {
                                ...
                                x.debug("Dropdown initialized on a select", e), P.is("select") && (q = P), q.parent($.dropdown).length > 0 ? (x.debug("UI dropdown already exists. Creating dropdown menu only"), P = q.closest($.dropdown), x.has.menu() || x.create.menu(), z = P.children($.menu), x.setup.menu(e)) : (x.debug("Creating entire dropdown from select"), P = t("<div />").attr("class", q.attr("class")).addClass(k.selection).addClass(k.dropdown).html(j.dropdown(e)).insertBefore(q), q.hasClass(k.multiple) && q.prop("multiple") === !1 && (x.error(O.missingMultiple), q.prop("multiple", !0)), q.is("[multiple]") && x.set.multiple(), q.prop("disabled") && (x.debug("Disabling dropdown"), P.addClass(k.disabled)), q.removeAttr("class").detach().prependTo(P)), x.refresh()
                            },
                            menu: function(t) {
                        ...
                        refreshSelectors: function() {
                            x.verbose("Refreshing selector cache"), R = P.find($.text), M = P.find($.search), q = P.find($.input), H = P.find($.icon), V = P.prev().find($.text).length > 0 ? P.prev().find($.text) : P.prev(), z = P.children($.menu), W = z.find($.item)
                        },
                        ...
                        get: {
                            ...
                            value: function() {
                                var e = q.length > 0 ? q.val() : P.data(T.value);
                        ...
                        set: {
                            ...
                            value: function(t, e, n) {
                                ...
                                } else x.verbose("Storing value in metadata", t, q), t !== r && P.data(T.value, s);
                        ...
                        escape: {
                            regExp: function(t) {
                                return t = String(t), t.replace(N.escape, "\\$&")
                            }
                        },
    ...
    1315: function(t, e, n) {
        ...
        t.exports = {
            ...
            data: {
                ...
                simulating: 0,
                notCheckDisconnect: !1,
                showDisconnectStatus: !0
            },
            mixins: [n(4)],
            translations: {
                g: global_locale
            ...
            ready: function() {
                ...
                return this.activeDevice = s.getActiveDevice(), this.activeDeviceConfig = s.getActiveDeviceConfig(), console.log(this.activeDeviceConfig), e && Object.keys(this.activeDevice).length ? (o.init(this), void r.init(this)) : (utils.directTo("index"), !1)
            },
            watch: {
                locale: function(t, e) {
                    s.setLang(t), this.$broadcast("locale", t)
                }
            },
            methods: {
                initstyle: function() {
                ...
                initial_ready: function(t) {
                    ...
                    }), e.cmdindexs = t.COMMAND, e.readReady = !0, e.makeDisable = !1, console.log("initial_ready"), e.book("preHash_af25148314bc844c58e380c7415e62fd", 2), e.book("preHash_e6c34752a8e4896f047b8c4daadba6c5", 2), e.book("preHash_d1e551218cf6f51982fef2cd4fdb093b", 2), e.book("preHash_1f9823d4b410a53b3fd4a2355a9bff91", 2)
                },
                ...
                device_arrival: function(t) {
                    ...
                    var e = !1;
                    s.addDevice(t) && t.FILE === this.activeDevice.FILE && (this.showDisconnectStatus && (this.connected = !0, this.makeContentDisable = !1, this.makeDisable = !1), this.notCheckDisconnect || (this.makeDisable = !0, this.readReady = !1, this.syncProgress = 0), this.$broadcast("device_arrival", t), e = !0), this.factory_enable && !e && this.$broadcast("device_arrival", t)
                },
                device_removed: function(t) {
                    var e = !1;
                    console.log("device_removed", t), s.removeDevice(t) && (console.log("remove successful", t.FILE), this.showDisconnectStatus && t.FILE === this.activeDevice.FILE && (this.connected = !1, this.makeContentDisable = !0, this.makeDisable = !0, e = !0, this.$broadcast("device_removed", t))), this.factory_enable && !e && this.$broadcast("device_removed", t)
                },
                unlock: function() {},
