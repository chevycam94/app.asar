...
! function(t, i) {
    ...
    function I(t, i, e) {
        ...
        return "touchstart" === i ? t.removeEventListener($i, n, !1) : "touchmove" === i ? t.removeEventListener(Qi, n, !1) : "touchend" === i && (t.removeEventListener(te, n, !1), t.removeEventListener(ie, n, !1)), this
    }

    function O(t, i, n) {
        var o = e(function(t) {
            if ("mouse" !== t.pointerType && t.pointerType !== t.MSPOINTER_TYPE_MOUSE && t.pointerType !== t.MSPOINTER_TYPE_MOUSE) {
                if (!(ee.indexOf(t.target.tagName) < 0)) return;
                $(t)
            }
            j(t, i)
        });
        t["_leaflet_touchstart" + n] = o, t.addEventListener($i, o, !1), oe || (document.documentElement.addEventListener($i, R, !0), document.documentElement.addEventListener(Qi, D, !0), document.documentElement.addEventListener(te, N, !0), document.documentElement.addEventListener(ie, N, !0), oe = !0)
    }
    ...
    function D(t) {
        ne[t.pointerId] && (ne[t.pointerId] = t)
    }

    function N(t) {
        delete ne[t.pointerId], se--
    }

    function j(t, i) {
        t.touches = [];
        for (var e in ne) t.touches.push(ne[e]);
    ...
    function H(t, i, e) {
        ...
        t["_leaflet_touchend" + e] = n, t.addEventListener(te, n, !1), t.addEventListener(ie, n, !1)
    }
    ...
    function F(t, i, e) {
        ...
        var s, r, a = !1,
            h = 250;
        return t[he + re + e] = n, t[he + ae + e] = o, t[he + "dblclick" + e] = i, t.addEventListener(re, n, !1), t.addEventListener(ae, o, !1), t.addEventListener("dblclick", i, !1), this
    }
    ...
    function U(t, i) {
        var e = t[he + re + i],
            n = t[he + ae + i],
            o = t[he + "dblclick" + i];
        return t.removeEventListener(re, e, !1), t.removeEventListener(ae, n, !1), Pi || t.removeEventListener("dblclick", o, !1), this
    }
    ...
    function q(t, i, e, n) {
        if ("object" == typeof i)
            ...
            for (var a in t[ue]) K(t, a, t[ue][a]);
            delete t[ue]
        }
        return this
    }
    ...
    function G(t, i, e, o) {
        var s = i + n(e) + (o ? "_" + n(o) : "");
        if (t[ue] && t[ue][s]) return this;
        var r = function(i) {
                return e.call(o || t, i || window.event)
            },
            a = r;
        Fi && 0 === i.indexOf("touch") ? A(t, i, r, s) : !Ui || "dblclick" !== i || !F || Fi && Zi ? "addEventListener" in t ? "mousewheel" === i ? t.addEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : "mouseenter" === i || "mouseleave" === i ? (r = function(i) {
            i = i || window.event, ot(t, i) && a(i)
        }, t.addEventListener("mouseenter" === i ? "mouseover" : "mouseout", r, !1)) : ("click" === i && bi && (r = function(t) {
            st(t, a)
        }), t.addEventListener(i, r, !1)) : "attachEvent" in t && t.attachEvent("on" + i, r) : F(t, r, s), t[ue] = t[ue] || {}, t[ue][s] = r
    }
    ...
    function K(t, i, e, o) {
        var s = i + n(e) + (o ? "_" + n(o) : ""),
            r = t[ue] && t[ue][s];
        if (!r) return this;
        Fi && 0 === i.indexOf("touch") ? I(t, i, s) : !Ui || "dblclick" !== i || !U || Fi && Zi ? "removeEventListener" in t ? "mousewheel" === i ? t.removeEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : t.removeEventListener("mouseenter" === i ? "mouseover" : "mouseleave" === i ? "mouseout" : i, r, !1) : "detachEvent" in t && t.detachEvent("on" + i, r) : U(t, s), t[ue][s] = null
    }
    ...
    function it(t) {
        return Pi ? t.wheelDeltaY / 2 : t.deltaY && 0 === t.deltaMode ? -t.deltaY / le : t.deltaY && 1 === t.deltaMode ? 20 * -t.deltaY : t.deltaY && 2 === t.deltaMode ? 60 * -t.deltaY : t.deltaX || t.deltaZ ? 0 : t.wheelDelta ? (t.wheelDeltaY || t.wheelDelta) / 2 : t.detail && Math.abs(t.detail) < 32765 ? 20 * -t.detail : t.detail ? t.detail / -32765 * 60 : 0
    }
    ...
    function wt(t, i, e) {
        var n = i || new x(0, 0);
        t.style[de] = (Ii ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (e ? " scale(" + e + ")" : "")
    }

    function Pt(t, i) {
        t._leaflet_pos = i, Di ? wt(t, i) : (t.style.left = i.x + "px", t.style.top = i.y + "px")
    }
    ...
    function zt(t) {
        ...
        t.style && (Mt(), ge = t, ve = t.style.outline, t.style.outline = "none", V(window, "keydown", Mt))
    }

    function Mt() {
        ge && (ge.style.outline = ve, ge = void 0, ve = void 0, q(window, "keydown", Mt))
    }
    ...
    function Bt(t, i, e, n, o) {
        var s, r, a, h = n ? Ce : It(t, e),
            u = It(i, e);
        for (Ce = u;;) {
            if (!(h | u)) return [t, i];
            if (h & u) return !1;
            a = It(r = At(t, i, s = h || u, e, o), e), s === h ? (t = r, h = a) : (i = r, u = a)
        }
    }
    ...
    function jt(t, i, e) {
        ...
        for (o = 0, u = t.length; o < u; o++) t[o]._code = It(t[o], i);
        for (r = 0; r < 4; r++) {
            for (l = _[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++) a = t[o], h = t[s], a._code & l ? h._code & l || ((c = At(h, a, l, i, e))._code = It(c, i), n.push(c)) : (h._code & l && ((c = At(h, a, l, i, e))._code = It(c, i), n.push(c)), n.push(a));
            t = n
        }
        return t
    }
    ...
    function Wt(t, i) {
        ...
        switch (r.type) {
            case "Point":
                return e = l(a), u ? u(t, e) : new Ye(e);
            case "MultiPoint":
                for (o = 0, s = a.length; o < s; o++) e = l(a[o]), h.push(u ? u(t, e) : new Ye(e));
                return new Ve(h);
            case "LineString":
            case "MultiLineString":
                return n = Ft(a, "LineString" === r.type ? 0 : 1, l), new Qe(n, i);
            case "Polygon":
            case "MultiPolygon":
                return n = Ft(a, "Polygon" === r.type ? 1 : 2, l), new tn(n, i);
    ...
    function Xt(t) {
        return Ki ? new mn(t) : null
    }

    function Jt(t) {
        return Yi || Xi ? new yn(t) : null
    }
    var $t = Object.freeze;
    ...
    var di, pi, mi, fi, gi = i({}, ci, {
        ...
        Mi = bi && B("Google") && zi < 537 && !("AudioNode" in window),
        Ci = !!window.opera,
        Zi = B("chrome"),
        Ei = B("gecko") && !Li && !Ci && !xi,
        Si = !Zi && B("safari"),
        ki = B("phantom"),
        Bi = "OTransition" in yi,
        Ai = 0 === navigator.platform.indexOf("Win"),
        Ii = xi && "transition" in yi,
        Oi = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !Ti,
        Ri = "MozPerspective" in yi,
        Di = !window.L_DISABLE_3D && (Ii || Oi || Ri) && !Bi && !ki,
        Ni = "undefined" != typeof orientation || B("mobile"),
        ji = Ni && Li,
        Wi = Ni && Oi,
        Hi = !window.PointerEvent && window.MSPointerEvent,
        Fi = !(!window.PointerEvent && !Hi),
        Ui = !window.L_NO_TOUCH && (Fi || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch),
        Vi = Ni && Ci,
        qi = Ni && Ei,
        ...
        Yi = !(!document.createElementNS || !S("svg").createSVGRect),
        Xi = !Yi && function() {
            try {
        ...
        $i = Hi ? "MSPointerDown" : "pointerdown",
        Qi = Hi ? "MSPointerMove" : "pointermove",
        te = Hi ? "MSPointerUp" : "pointerup",
        ie = Hi ? "MSPointerCancel" : "pointercancel",
        ee = ["INPUT", "SELECT", "OPTION"],
        ne = {},
        oe = !1,
        se = 0,
        re = Hi ? "MSPointerDown" : Fi ? "pointerdown" : "touchstart",
        ae = Hi ? "MSPointerUp" : Fi ? "pointerup" : "touchend",
        he = "_leaflet_",
        ue = "_leaflet_events",
        le = Ai && Zi ? 2 * window.devicePixelRatio : Ei ? window.devicePixelRatio : 1,
        ce = {},
        ...
        de = xt(["transform", "WebkitTransform", "OTransform", "MozTransform", "msTransform"]),
        pe = xt(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]),
        me = "webkitTransition" === pe || "OTransition" === pe ? pe + "End" : "transitionend";
    if ("onselectstart" in document) pi = function() {
        ...
        var fe = xt(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
        pi = function() {
            if (fe) {
            ...
            fe && (document.documentElement.style[fe] = fi, fi = void 0)
        }
    }
    var ge, ve, ye = (Object.freeze || Object)({
            TRANSFORM: de,
            TRANSITION: pe,
            TRANSITION_END: me,
            get: rt,
        ...
        xe = ui.extend({
            run: function(t, i, e, n) {
                this.stop(), this._el = t, this._inProgress = !0, this._duration = e || .25, this._easeOutPower = 1 / Math.max(n || .5, .2), this._startPos = Lt(t), this._offset = i.subtract(this._startPos), this._startTime = +new Date, this.fire("start"), this._animate()
            },
            stop: function() {
            ...
            _runFrame: function(t, i) {
                ...
                i && e._round(), Pt(this._el, e), this.fire("step")
            },
            _complete: function() {
        ...
        we = ui.extend({
            ...
            initialize: function(t, i) {
                i = l(this, i), this._initContainer(t), this._initLayout(), this._onResize = e(this._onResize, this), this._initEvents(), i.maxBounds && this.setMaxBounds(i.maxBounds), void 0 !== i.zoom && (this._zoom = this._limitZoom(i.zoom)), i.center && void 0 !== i.zoom && this.setView(C(i.center), i.zoom, {
                    reset: !0
                }), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = !0, this.callInitHooks(), this._zoomAnimated = pe && Di && !Vi && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), V(this._proxy, me, this._catchTransitionEnd, this)), this._addLayers(this.options.layers)
            },
            ...
            zoomIn: function(t, i) {
                return t = t || (Di ? this.options.zoomDelta : 1), this.setZoom(this._zoom + t, i)
            },
            ...
            panBy: function(t, i) {
                ...
                if (this._panAnim || (this._panAnim = new xe, this._panAnim.on({
            ...
            flyTo: function(t, i, e) {
                ...
                if (!1 === (e = e || {}).animate || !Di) return this.setView(t, i, e);
                this._stop();
            ...
            _initLayout: function() {
                ...
                this._fadeAnimated = this.options.fadeAnimation && Di, pt(t, "leaflet-container" + (Ui ? " leaflet-touch" : "") + (Gi ? " leaflet-retina" : "") + (wi ? " leaflet-oldie" : "") + (Si ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
                var i = at(t, "position");
            ...
            _rawPanBy: function(t) {
                Pt(this._mapPane, this._getMapPanePos().subtract(t))
            },
            ...
            _initEvents: function(t) {
                ...
                var i = t ? q : V;
                i(this._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this._handleDOMEvent, this), this.options.trackResize && i(window, "resize", this._onResize, this), Di && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd)
            },
            _onResize: function() {
    ...
    var be = Pe.extend({
            ...
            _initLayout: function() {
                ...
                o.href = "#", o.title = "Layers", Ui ? (V(o, "click", Q), V(o, "click", this.expand, this)) : V(o, "focus", this.expand, this), e || this.expand(), this._baseLayersList = ht("div", t + "-base", n), this._separator = ht("div", t + "-separator", n), this._overlaysList = ht("div", t + "-overlays", n), i.appendChild(n)
            },
    ...
    we.mergeOptions({
        zoomControl: !0
    }), we.addInitHook(function() {
        this.options.zoomControl && (this.zoomControl = new Te, this.addControl(this.zoomControl))
    });
    var ze = Pe.extend({
            options: {
                position: "bottomleft",
    ...
    Pe.Layers = be, Pe.Zoom = Te, Pe.Scale = ze, Pe.Attribution = Me, Le.layers = function(t, i, e) {
        return new be(t, i, e)
    }, Le.zoom = function(t) {
        return new Te(t)
    }, Le.scale = function(t) {
    ...
    var Ce, Ze = v.extend({
        ...
        Se = Ui ? "touchstart mousedown" : "mousedown",
        ke = {
            mousedown: "mouseup",
            touchstart: "touchend",
        ...
        Ae = ui.extend({
            ...
            enable: function() {
                this._enabled || (V(this._dragStartTarget, Se, this._onDown, this), this._enabled = !0)
            },
            disable: function() {
                this._enabled && (Ae._dragging === this && this.finishDrag(), q(this._dragStartTarget, Se, this._onDown, this), this._enabled = !1, this._moved = !1)
            },
            _onDown: function(t) {
                if (!t._simulated && this._enabled && (this._moved = !1, !dt(this._element, "leaflet-zoom-anim") && !(Ae._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (Ae._dragging = this, this._preventOutline && zt(this._element), bt(), pi(), this._moving)))) {
                    this.fire("down");
                    var i = t.touches ? t.touches[0] : t;
                    this._startPoint = new x(i.clientX, i.clientY), V(document, Be[t.type], this._onMove, this), V(document, ke[t.type], this._onUp, this)
                }
            },
            _onMove: function(t) {
                if (!t._simulated && this._enabled)
                    if (t.touches && t.touches.length > 1) this._moved = !0;
                        ...
                        (e.x || e.y) && (Math.abs(e.x) + Math.abs(e.y) < this.options.clickTolerance || ($(t), this._moved || (this.fire("dragstart"), this._moved = !0, this._startPos = Lt(this._element).subtract(e), pt(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), pt(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(e), this._moving = !0, g(this._animRequest), this._lastEvent = t, this._animRequest = f(this._updatePosition, this, !0)))
                    }
            },
            _updatePosition: function() {
                ...
                this.fire("predrag", t), Pt(this._element, this._newPos), this.fire("drag", t)
            },
            _onUp: function(t) {
            ...
            finishDrag: function() {
                ...
                for (var t in Be) q(document, Be[t], this._onMove, this), q(document, ke[t], this._onUp, this);
    ...
    li.Earth = ci, li.EPSG3395 = je, li.EPSG3857 = gi, li.EPSG900913 = vi, li.EPSG4326 = We, li.Simple = He;
    var Fe = ui.extend({
        options: {
            pane: "overlayPane",
            attribution: null,
    ...
    var Ue = Fe.extend({
        ...
        Ve = Ue.extend({
            addLayer: function(t) {
                return this.hasLayer(t) ? this : (t.addEventParent(this), Ue.prototype.addLayer.call(this, t), this.fire("layeradd", {
                    layer: t
                }))
            },
            removeLayer: function(t) {
                return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]), t.removeEventParent(this), Ue.prototype.removeLayer.call(this, t), this.fire("layerremove", {
                    layer: t
                })) : this
            },
            setStyle: function(t) {
        ...
        qe = v.extend({
            ...
            _getIconUrl: function(t) {
                return Gi && this.options[t + "RetinaUrl"] || this.options[t + "Url"]
            }
        }),
        Ge = qe.extend({
            options: {
            ...
            _getIconUrl: function(t) {
                return Ge.imagePath || (Ge.imagePath = this._detectIconPath()), (this.options.imagePath || Ge.imagePath) + qe.prototype._getIconUrl.call(this, t)
            },
        ...
        Ke = Ze.extend({
            ...
            _onDrag: function(t) {
                ...
                e && Pt(e, n), i._latlng = o, t.latlng = o, t.oldLatLng = this._oldLatLng, i.fire("move", t).fire("drag", t)
            },
        ...
        Ye = Fe.extend({
            ...
            _setPos: function(t) {
                Pt(this._icon, t), this._shadow && Pt(this._shadow, t), this._zIndex = t.y + this.options.zIndexOffset, this._resetZIndex()
            },
            ...
            _initInteraction: function() {
                if (this.options.interactive && (pt(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Ke)) {
        ...
        Xe = Fe.extend({
            ...
            _clickTolerance: function() {
                return (this.options.stroke ? this.options.weight / 2 : 0) + (Ui ? 10 : 0)
            }
        }),
        Je = Xe.extend({
            options: {
    ...
    var tn = Qe.extend({
            ...
            _convertLatLngs: function(t) {
                var i = Qe.prototype._convertLatLngs.call(this, t),
                    e = i.length;
                return e >= 2 && i[0] instanceof M && i[0].equals(i[e - 1]) && i.pop(), i
            },
            _setLatLngs: function(t) {
                Qe.prototype._setLatLngs.call(this, t), Dt(this._latlngs) && (this._latlngs = [this._latlngs])
            },
            _defaultShape: function() {
            ...
            _containsPoint: function(t) {
                ...
                return u || Qe.prototype._containsPoint.call(this, t, !0)
            }
        }),
        en = Ve.extend({
            initialize: function(t, i) {
    ...
    Ye.include(nn), $e.include(nn), Je.include(nn), Qe.include({
        toGeoJSON: function(t) {
    ...
    var on = Kt,
        sn = Fe.extend({
            ...
            _reset: function() {
                var t = this._image,
                    ...
                    e = i.getSize();
                Pt(t, i.min), t.style.width = e.x + "px", t.style.height = e.y + "px"
            },
            _updateOpacity: function() {
            ...
            _updatePosition: function() {
                if (this._map) {
                    var t = this._map.latLngToLayerPoint(this._latlng),
                        ...
                        e = this._getAnchor();
                    this._zoomAnimated ? Pt(this._container, t.add(e)) : i = i.add(t).add(e);
        ...
        hn = an.extend({
            ...
            onAdd: function(t) {
                an.prototype.onAdd.call(this, t), t.fire("popupopen", {
                    popup: this
                }), this._source && (this._source.fire("popupopen", {
                    popup: this
                }, !0), this._source instanceof Xe || this._source.on("preclick", Y))
            },
            onRemove: function(t) {
                an.prototype.onRemove.call(this, t), t.fire("popupclose", {
                    popup: this
                }), this._source && (this._source.fire("popupclose", {
                    popup: this
                }, !0), this._source instanceof Xe || this._source.off("preclick", Y))
            },
            getEvents: function() {
    ...
    we.mergeOptions({
        ...
        bindPopup: function(t, i) {
            return t instanceof hn ? (l(t, i), this._popup = t, t._source = this) : (this._popup && !i || (this._popup = new hn(i, this)), this._popup.setContent(t)), this._popupHandlersAdded || (this.on({
        ...
        openPopup: function(t, i) {
            if (t instanceof Fe || (i = t, t = this), t instanceof Ve)
        ...
        _openPopup: function(t) {
            ...
            this._popup && this._map && (Q(t), i instanceof Xe ? this.openPopup(t.layer || t.target, t.latlng) : this._map.hasLayer(this._popup) && this._popup._source === i ? this.closePopup() : this.openPopup(i, t.latlng))
        },
    ...
    var un = an.extend({
        ...
        onAdd: function(t) {
            an.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", {
                tooltip: this
        ...
        onRemove: function(t) {
            an.prototype.onRemove.call(this, t), t.fire("tooltipclose", {
                tooltip: this
        ...
        getEvents: function() {
            var t = an.prototype.getEvents.call(this);
            return Ui && !this.options.permanent && (t.preclick = this._close), t
        },
        _close: function() {
        ...
        _setPosition: function(t) {
            var i = this._map,
                ...
                u = this._getAnchor();
            "top" === s ? t = t.add(w(-r / 2 + h.x, -a + h.y + u.y, !0)) : "bottom" === s ? t = t.subtract(w(r / 2 - h.x, -h.y, !0)) : "center" === s ? t = t.subtract(w(r / 2 + h.x, a / 2 - u.y + h.y, !0)) : "right" === s || "auto" === s && o.x < n.x ? (s = "right", t = t.add(w(h.x + u.x, u.y - a / 2 + h.y, !0))) : (s = "left", t = t.subtract(w(r + u.x - h.x, a / 2 - u.y - h.y, !0))), mt(e, "leaflet-tooltip-right"), mt(e, "leaflet-tooltip-left"), mt(e, "leaflet-tooltip-top"), mt(e, "leaflet-tooltip-bottom"), pt(e, "leaflet-tooltip-" + s), Pt(e, t)
        },
        _updatePosition: function() {
            var t = this._map.latLngToLayerPoint(this._latlng);
            this._setPosition(t)
    ...
    we.include({
        openTooltip: function(t, i, e) {
            return t instanceof un || (t = new un(e).setContent(t)), i && t.setLatLng(i), this.hasLayer(t) ? this : this.addLayer(t)
        },
        ...
        bindTooltip: function(t, i) {
            return t instanceof un ? (l(t, i), this._tooltip = t, t._source = this) : (this._tooltip && !i || (this._tooltip = new un(i, this)), this._tooltip.setContent(t)), this._initTooltipInteractions(), this._tooltip.options.permanent && this._map && this._map.hasLayer(this) && this.openTooltip(), this
        },
        ...
        _initTooltipInteractions: function(t) {
            if (t || !this._tooltipHandlersAdded) {
                ...
                this._tooltip.options.permanent ? e.add = this._openTooltip : (e.mouseover = this._openTooltip, e.mouseout = this.closeTooltip, this._tooltip.options.sticky && (e.mousemove = this._moveTooltip), Ui && (e.click = this._openTooltip)), this[i](e), this._tooltipHandlersAdded = !t
            }
        },
    ...
    var cn = Fe.extend({
            ...
            _removeTile: function(t) {
                var i = this._tiles[t];
                i && (Mi || i.el.setAttribute("src", ni), ut(i.el), delete this._tiles[t], this.fire("tileunload", {
                    tile: i.el,
            ...
            _initTile: function(t) {
                ...
                t.style.width = i.x + "px", t.style.height = i.y + "px", t.onselectstart = r, t.onmousemove = r, wi && this.options.opacity < 1 && vt(t, this.options.opacity), bi && !Ti && (t.style.WebkitBackfaceVisibility = "hidden")
            },
            _addTile: function(t, i) {
                var n = this._getTilePos(t),
                    o = this._tileCoordsToKey(t),
                    s = this.createTile(this._wrapCoords(t), e(this._tileReady, this, t));
                this._initTile(s), this.createTile.length < 2 && f(e(this._tileReady, this, t, null, s)), Pt(s, n), this._tiles[o] = {
                    el: s,
                    coords: t,
                    current: !0
        ...
        _n = cn.extend({
            ...
            initialize: function(t, i) {
                this._url = t, (i = l(this, i)).detectRetina && Gi && i.maxZoom > 0 && (i.tileSize = Math.floor(i.tileSize / 2), i.zoomReverse ? (i.zoomOffset--, i.minZoom++) : (i.zoomOffset++, i.maxZoom--), i.minZoom = Math.max(0, i.minZoom)), "string" == typeof i.subdomains && (i.subdomains = i.subdomains.split("")), bi || this.on("tileunload", this._onTileRemove)
            },
            setUrl: function(t, i) {
        ...
        dn = _n.extend({
            ...
            initialize: function(t, e) {
                ...
                e = l(this, e), n.width = n.height = e.tileSize * (e.detectRetina && Gi ? 2 : 1), this.wmsParams = n
            },
            onAdd: function(t) {
                this._crs = this.options.crs || t.options.crs, this._wmsVersion = parseFloat(this.wmsParams.version);
                var i = this._wmsVersion >= 1.3 ? "crs" : "srs";
                this.wmsParams[i] = this._crs.code, _n.prototype.onAdd.call(this, t)
            },
            getTileUrl: function(t) {
                var i = this._tileCoordsToBounds(t),
                    e = this._crs.project(i.getNorthWest()),
                    n = this._crs.project(i.getSouthEast()),
                    o = (this._wmsVersion >= 1.3 && this._crs === We ? [n.y, e.x, e.y, n.x] : [e.x, n.y, n.x, e.y]).join(","),
                    s = _n.prototype.getTileUrl.call(this, t);
    ...
    var pn = Fe.extend({
            ...
            _updateTransform: function(t, i) {
                ...
                Di ? wt(this._container, a, e) : Pt(this._container, a)
            },
            _reset: function() {
        ...
        mn = pn.extend({
            ...
            _update: function() {
                if (!this._map._animatingZoom || !this._bounds) {
                    this._drawnLayers = {}, pn.prototype._update.call(this);
                    var t = this._bounds,
                        i = this._container,
                        e = t.getSize(),
                        n = Gi ? 2 : 1;
                    Pt(i, t.min), i.width = n * e.x, i.height = n * e.y, i.style.width = e.x + "px", i.style.height = e.y + "px", Gi && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update")
                }
            },
            _reset: function() {
        ...
        gn = {
            ...
            _initPath: function(t) {
                ...
                pt(i, "leaflet-vml-shape " + (this.options.className || "")), i.coordsize = "1 1", t._path = fn("path"), i.appendChild(t._path), this._updateStyle(t), this._layers[n(t)] = t
            },
            _addPath: function(t) {
                var i = t._container;
            ...
            _updateStyle: function(t) {
                var i = t._stroke,
                    ...
                    n = t.options,
                    o = t._container;
                o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (i || (i = t._stroke = fn("stroke")), o.appendChild(i), i.weight = n.weight + "px", i.color = n.color, i.opacity = n.opacity, n.dashArray ? i.dashStyle = ei(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : i.dashStyle = "", i.endcap = n.lineCap.replace("butt", "flat"), i.joinstyle = n.lineJoin) : i && (o.removeChild(i), t._stroke = null), n.fill ? (e || (e = t._fill = fn("fill")), o.appendChild(e), e.color = n.fillColor || n.color, e.opacity = n.fillOpacity) : e && (o.removeChild(e), t._fill = null)
            },
            _updateCircle: function(t) {
        ...
        yn = pn.extend({
            ...
            _initContainer: function() {
                this._container = vn("svg"), this._container.setAttribute("pointer-events", "none"), this._rootGroup = vn("g"), this._container.appendChild(this._rootGroup)
            },
            _destroyContainer: function() {
            ...
            _update: function() {
                if (!this._map._animatingZoom || !this._bounds) {
                    ...
                    var t = this._bounds,
                        i = t.getSize(),
                        e = this._container;
                    this._svgSize && this._svgSize.equals(i) || (this._svgSize = i, e.setAttribute("width", i.x), e.setAttribute("height", i.y)), Pt(e, t.min), e.setAttribute("viewBox", [t.min.x, t.min.y, i.x, i.y].join(" ")), this.fire("update")
                }
            },
            _initPath: function(t) {
                var i = t._path = vn("path");
    ...
    var xn = tn.extend({
        initialize: function(t, i) {
            tn.prototype.initialize.call(this, this._boundsToLatLngs(t), i)
        },
        setBounds: function(t) {
    ...
    yn.create = vn, yn.pointsToPath = k, en.geometryToLayer = Wt, en.coordsToLatLng = Ht, en.coordsToLatLngs = Ft, en.latLngToCoords = Ut, en.latLngsToCoords = Vt, en.getFeature = qt, en.asFeature = Gt, we.mergeOptions({
        boxZoom: !0
    });
    var wn = Ze.extend({
        initialize: function(t) {
        ...
        _onMouseDown: function(t) {
            ...
            this._clearDeferredResetState(), this._resetState(), pi(), bt(), this._startPoint = this._map.mouseEventToContainerPoint(t), V(document, {
                contextmenu: Q,
        ...
        _onMouseMove: function(t) {
            ...
            var i = new P(this._point, this._startPoint),
                e = i.getSize();
            Pt(this._box, i.min), this._box.style.width = e.x + "px", this._box.style.height = e.y + "px"
        },
        _finish: function() {
            this._moved && (ut(this._box), mt(this._container, "leaflet-crosshair")), mi(), Tt(), q(document, {
                contextmenu: Q,
                mousemove: this._onMouseMove,
                mouseup: this._onMouseUp,
                keydown: this._onKeyDown
    ...
    we.addInitHook("addHandler", "boxZoom", wn), we.mergeOptions({
        doubleClickZoom: !0
    });
    var Pn = Ze.extend({
        addHooks: function() {
    ...
    we.addInitHook("addHandler", "doubleClickZoom", Pn), we.mergeOptions({
        dragging: !0,
        inertia: !Ti,
    ...
    var Ln = Ze.extend({
        addHooks: function() {
            if (!this._draggable) {
                var t = this._map;
                this._draggable = new Ae(t._mapPane, t._container), this._draggable.on({
                    dragstart: this._onDragStart,
                    drag: this._onDrag,
                    dragend: this._onDragEnd
    ...
    we.addInitHook("addHandler", "dragging", Ln), we.mergeOptions({
        keyboard: !0,
        keyboardPanDelta: 80
    });
    var bn = Ze.extend({
    ...
    we.addInitHook("addHandler", "keyboard", bn), we.mergeOptions({
        scrollWheelZoom: !0,
    ...
    we.addInitHook("addHandler", "scrollWheelZoom", Tn), we.mergeOptions({
        tap: !0,
        tapTolerance: 15
    });
    var zn = Ze.extend({
    ...
    Ui && !Fi && we.addInitHook("addHandler", "tap", zn), we.mergeOptions({
        touchZoom: Ui && !Ti,
    ...
    we.addInitHook("addHandler", "touchZoom", Mn), we.BoxZoom = wn, we.DoubleClickZoom = Pn, we.Drag = Ln, we.Keyboard = bn, we.ScrollWheelZoom = Tn, we.Tap = zn, we.TouchZoom = Mn;
    var Cn = window.L;
    window.L = t, Object.freeze = $t, t.version = "1.2.0+HEAD.cbb89c1", t.noConflict = function() {
        return window.L = Cn, this
    }, t.Control = Pe, t.control = Le, t.Browser = Ji, t.Evented = ui, t.Mixin = Ee, t.Util = ai, t.Class = v, t.Handler = Ze, t.extend = i, t.bind = e, t.stamp = n, t.setOptions = l, t.DomEvent = _e, t.DomUtil = ye, t.PosAnimation = xe, t.Draggable = Ae, t.LineUtil = Ie, t.PolyUtil = Oe, t.Point = x, t.point = w, t.Bounds = P, t.bounds = b, t.Transformation = Z, t.transformation = E, t.Projection = Ne, t.LatLng = M, t.latLng = C, t.LatLngBounds = T, t.latLngBounds = z, t.CRS = li, t.GeoJSON = en, t.geoJSON = Kt, t.geoJson = on, t.Layer = Fe, t.LayerGroup = Ue, t.layerGroup = function(t) {
        return new Ue(t)
    }, t.FeatureGroup = Ve, t.featureGroup = function(t) {
        return new Ve(t)
    }, t.ImageOverlay = sn, t.imageOverlay = function(t, i, e) {
        return new sn(t, i, e)
    }, t.VideoOverlay = rn, t.videoOverlay = function(t, i, e) {
        return new rn(t, i, e)
    }, t.DivOverlay = an, t.Popup = hn, t.popup = function(t, i) {
        return new hn(t, i)
    }, t.Tooltip = un, t.tooltip = function(t, i) {
        return new un(t, i)
    }, t.Icon = qe, t.icon = function(t) {
        return new qe(t)
    }, t.DivIcon = ln, t.divIcon = function(t) {
        return new ln(t)
    }, t.Marker = Ye, t.marker = function(t, i) {
        return new Ye(t, i)
    }, t.TileLayer = _n, t.tileLayer = Yt, t.GridLayer = cn, t.gridLayer = function(t) {
        return new cn(t)
    }, t.SVG = yn, t.svg = Jt, t.Renderer = pn, t.Canvas = mn, t.canvas = Xt, t.Path = Xe, t.CircleMarker = Je, t.circleMarker = function(t, i) {
        return new Je(t, i)
    }, t.Circle = $e, t.circle = function(t, i, e) {
        return new $e(t, i, e)
    }, t.Polyline = Qe, t.polyline = function(t, i) {
        return new Qe(t, i)
    }, t.Polygon = tn, t.polygon = function(t, i) {
        return new tn(t, i)
    }, t.Rectangle = xn, t.rectangle = function(t, i) {
        return new xn(t, i)
    }, t.Map = we, t.map = function(t, i) {
        return new we(t, i)
    }
});