! function(e) {
    ...
    6: function(e, t, n) {
        ...
        function r(e) {
            ...
            if (i || r) {
                ...
                for (f.innerHTML = c + e.trim() + p; a--;) f = f.lastChild;
    ...
    11: function(e, t, n) {
        ...
        t.parse = function(e) {
            ...
            for (var n, i, s, o, u, d, h = [], f = l.lastIndex = 0; n = l.exec(e);) i = n.index, i > f && h.push({
                value: e.slice(f, i)
    ...
    12: function(e, t, n) {
        ...
        function r() {
            var e, t = o.slice(_, l).trim();
            if (t) {
                e = {};
                var n = t.match(S);
                e.name = n[0], n.length > 1 && (e.args = n.slice(1).map(s))
            }
            e && (b.filters = b.filters || []).push(e), _ = l + 1
        }

        function s(e) {
            var t = E.test(e) ? e : w.stripQuotes(e),
                n = t === !1;
            return {
                value: n ? e : t,
                dynamic: n
        ...
        t.parse = function(e) {
            var t = C.get(e);
            if (t) return t;
            for (o = e, u = d = !1, h = p = f = g = m = 0, _ = 0, v = [], b = {}, y = null, l = 0, c = o.length; l < c; l++)
    ...
    13: function(e, t, n) {
        ...
        function o(e, t) {
            b.test(e) && "production" !== process.env.NODE_ENV && d.warn("Avoid using reserved keywords in expression: " + e), E.length = 0;
            var n = e.replace(w, i).replace(_, "");
    ...
    14: function(e, t, n) {
        ...
        function r(e) {
            function t() {
                var t = e[f + 1];
                if (g === y && "'" === t || g === w && '"' === t) return f++, r = t, m[d](), !0
            }
            var n, r, s, o, a, l, c, u = [],
                f = -1,
                g = p,
    ...
    135: function(e, t, n) {
        ...
        ! function(t, n) {
            ...
            function k(e) {
                var t = te,
                    n = ze[e];
                return n || (n = C(e, t), "none" !== n && n || (We = (We || ie("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = We[0].contentDocument, t.write(), t.close(), n = C(e, t), We.detach()), ze[e] = n), n
            }

            function S(e, t, n) {
                var i, r, s, o, a = e.style;
                return n = n || Ue(e), n && (o = n.getPropertyValue(t) || n[t]), n && ("" !== o || ie.contains(e.ownerDocument, e) || (o = ie.style(e, t)), Je.test(o) && Ve.test(t) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s)), void 0 !== o ? o + "" : o
            }
            ...
            function N(e, t, n, i, r) {
                for (var s = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2) "margin" === n && (o += ie.css(e, n + Ee[s], !0, r)), i ? ("content" === n && (o -= ie.css(e, "padding" + Ee[s], !0, r)), "margin" !== n && (o -= ie.css(e, "border" + Ee[s] + "Width", !0, r))) : (o += ie.css(e, "padding" + Ee[s], !0, r), "padding" !== n && (o += ie.css(e, "border" + Ee[s] + "Width", !0, r)));
                return o
            }
            ...
            function D(e, t) {
                for (var n, i, r, s = [], o = 0, a = e.length; a > o; o++) i = e[o], i.style && (s[o] = we.get(i, "olddisplay"), n = i.style.display, t ? (s[o] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ae(i) && (s[o] = we.access(i, "olddisplay", k(i.nodeName)))) : (r = Ae(i), "none" === n && r || we.set(i, "olddisplay", r ? n : ie.css(i, "display"))));
            ...
            function F(e, t, n) {
                ...
                })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = ie.css(e, "display"), u = "none" === c ? we.get(e, "olddisplay") || k(e.nodeName) : c, "inline" === u && "none" === ie.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function() {
                ...
                if (ie.isEmptyObject(h)) "inline" === ("none" === c ? k(e.nodeName) : c) && (p.display = c);
                else {
                    g ? "hidden" in g && (f = g.hidden) : g = we.access(e, "fxshow", {}), s && (g.hidden = !f), f ? ie(e).show() : d.done(function() {
                        ie(e).hide()
                    }), d.done(function() {
                        var t;
                        we.remove(e, "fxshow");
                    ...
                    for (i in h) o = I(f ? g[i] : 0, i, d), i in g || (g[i] = o.start, f && (o.end = o.start, o.start = "width" === i || "height" === i ? 1 : 0))
                }
            }
            ...
            function L(e, t, n) {
                ...
                return ie.map(u, I, c), ie.isFunction(c.opts.start) && c.opts.start.call(e, c), ie.fx.timer(ie.extend(l, {
                    elem: e,
                    anim: c,
                    queue: c.opts.queue
            ...
            function z(e, t, n, i) {
                ...
                if (ie.isArray(t)) ie.each(t, function(t, r) {
                    n || Tt.test(e) ? i(e, r) : z(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, i)
                });
            ...
            ie.fn = ie.prototype = {
                ...
                makeArray: function(e, t) {
                    var n = t || [];
                    return null != e && (s(Object(e)) ? ie.merge(n, "string" == typeof e ? [e] : e) : Y.call(n, e)), n
                },
                ...
                map: function(e, t, n) {
                    var i, r = 0,
                        ...
                        l = [];
                    if (a)
                        for (; o > r; r++) i = t(e[r], r, n), null != i && l.push(i);
                    else
            ...
            var le = function(e) {
                function t(e, t, n, i) {
                    ...
                    if ((t ? t.ownerDocument || t : q) !== O && D(t), t = t || O, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a) return n;
                    if (!i && P) {
                        if (11 !== a && (r = be.exec(e)))
                            if (o = r[1]) {
                                if (9 === a) {
                                ...
                                } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(o)) && L(t, s) && s.id === o) return n.push(s), n
                            } else {
                        ...
                        if (w.qsa && (!I || !I.test(e))) {
                            if (p = d = R, f = t, g = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                                for (c = S(e), (d = t.getAttribute("id")) ? p = d.replace(ye, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + h(c[l]);
                ...
                function b(e) {
                    for (var t, n, i, r = e.length, s = x.relative[e[0].type], o = s || x.relative[" "], a = s ? 1 : 0, l = p(function(e) {
                            return e === t
                        }, o, !0), c = p(function(e) {
                            return ee(t, e) > -1
                        }, o, !0), u = [function(e, n, i) {
                            var r = !s && (i || n !== T) || ((t = n).nodeType ? l(e, n, i) : c(e, n, i));
                            return t = null, r
                        }]; r > a; a++)
                        if (n = x.relative[e[a].type]) u = [p(f(u), n)];
                            ...
                            if (n = x.filter[e[a].type].apply(null, e[a].matches), n[R]) {
                                ...
                                return v(a > 1 && f(u), a > 1 && h(e.slice(0, a - 1).concat({
                                    value: " " === e[a - 2].type ? "*" : ""
                                })).replace(le, "$1"), n, i > a && b(e.slice(a, i)), r > i && b(e = e.slice(i)), r > i && h(e))
                            }
                            u.push(n)
                        }
                    return f(u)
                ...
                var y, w, x, C, k, S, E, A, T, N, $, D, O, j, P, I, F, M, L, R = "sizzle" + 1 * new Date,
                    q = e.document,
                    H = 0,
                    B = 0,
                    W = n(),
                ...
                w = t.support = {}, k = t.isXML = function(e) {
                    ...
                    return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, j = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), P = !k(i), w.attributes = r(function(e) {
                    ...
                    }, F = [], I = [], (w.qsa = ve.test(i.querySelectorAll)) && (r(function(e) {
                    ...
                    })), (w.matchesSelector = ve.test(M = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && r(function(e) {
                        w.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), F.push("!=", oe)
                    }), I = I.length && new RegExp(I.join("|")), F = F.length && new RegExp(F.join("|")), t = ve.test(j.compareDocumentPosition), L = t || ve.test(j.contains) ? function(e, t) {
                        ...
                        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === q && L(q, e) ? -1 : t === i || t.ownerDocument === q && L(q, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return $ = !0, 0;
                        var n, r = 0,
                            s = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== O && D(e), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !P || F && F.test(n) || I && I.test(n))) try {
                        var i = M.call(e, n);
                        if (i || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
                    } catch (e) {}
                    return t(n, O, null, [e]).length > 0
                }, t.contains = function(e, t) {
                    return (e.ownerDocument || e) !== O && D(e), L(e, t)
                }, t.attr = function(e, t) {
                            ...
                            return 1 === i && 0 === r ? function(e) {
                                ...
                                if (m) {
                                    ...
                                    if (f = [o ? m.firstChild : m.lastChild], o && b) {
                                        for (u = m[R] || (m[R] = {}), c = u[e] || [], p = c[0] === H && c[1], h = c[0] === H && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (h = p = 0) || f.pop();)
                                            if (1 === d.nodeType && ++h && d === t) {
                                                u[e] = [H, p, h];
                                                break
                                            }
                                    } else if (b && (c = (t[R] || (t[R] = {}))[e]) && c[0] === H) h = c[1];
                                    else
                                        for (;
                                            (d = ++p && d && d[g] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++h || (b && ((d[R] || (d[R] = {}))[e] = [H, h]), d !== t)););
                ...
                return d.prototype = x.filters = x.pseudos, x.setFilters = new d, S = t.tokenize = function(e, n) {
                    ...
                    for (a = e, l = [], c = x.preFilter; a;) {
                        ...
                        for (o in x.filter) !(r = fe[o].exec(a)) || c[o] && !(r = c[o](r)) || (i = r.shift(), s.push({
                            value: i,
                            type: o,
                            matches: r
                        }), a = a.slice(i.length));
                    ...
                    var n, i = [],
                        ...
                        s = V[e + " "];
                    if (!s) {
                        for (t || (t = S(e)), n = t.length; n--;) s = b(t[n]), s[R] ? i.push(s) : r.push(s);
                        s = V(e, _(r, i)), s.selector = e
                    }
                    return s
                    ...
                    if (n = n || [], 1 === d.length) {
                        if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && w.getById && 9 === t.nodeType && P && x.relative[s[1].type]) {
                            if (t = (x.find.ID(o.matches[0].replace(we, xe), t) || [])[0], !t) return n;
                            c && (t = t.parentNode), e = e.slice(s.shift().value.length)
                        }
                        for (r = fe.needsContext.test(e) ? 0 : s.length; r-- && (o = s[r], !x.relative[a = o.type]);)
                            if ((l = x.find[a]) && (i = l(o.matches[0].replace(we, xe), _e.test(s[0].type) && u(t.parentNode) || t))) {
                                if (s.splice(r, 1), e = i.length && h(s), !e) return Z.apply(n, i), n;
                                break
                            }
                    }
                    return (c || E(e, d))(i, t, !P, n, _e.test(e) && u(t.parentNode) || t), n
            ...
            ie.fn.ready = function(e) {
                ...
                ready: function(e) {
                    (e === !0 ? --ie.readyWait : ie.isReady) || (ie.isReady = !0, e !== !0 && --ie.readyWait > 0 || (_e.resolveWith(te, [ie]), ie.fn.triggerHandler && (ie(te).triggerHandler("ready"), ie(te).off("ready"))))
                }
            }), ie.ready.promise = function(t) {
                return _e || (_e = ie.Deferred(), "complete" === te.readyState ? setTimeout(ie.ready) : (te.addEventListener("DOMContentLoaded", u, !1), e.addEventListener("load", u, !1))), _e.promise(t)
            }, ie.ready.promise();
            ...
            ie.event = {
                ...
                add: function(e, t, n, i, r) {
                    var s, o, a, l, c, u, d, h, p, f, g, m = we.get(e);
                    if (m)
                        for (n.handler && (s = n, n = s.handler, r = s.selector), n.guid || (n.guid = ie.guid++), (l = m.events) || (l = m.events = {}), (o = m.handle) || (o = m.handle = function(t) {
                            ...
                            }), t = (t || "").match(ve) || [""], c = t.length; c--;) a = je.exec(t[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p && (d = ie.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, d = ie.event.special[p] || {}, u = ie.extend({
                            type: p,
                            origType: g,
                            data: i,
                            handler: n,
                            ...
                            namespace: f.join(".")
                        }, s), (h = l[p]) || (h = l[p] = [], h.delegateCount = 0, d.setup && d.setup.call(e, i, f, o) !== !1 || e.addEventListener && e.addEventListener(p, o, !1)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? h.splice(h.delegateCount++, 0, u) : h.push(u), ie.event.global[p] = !0)
                },
                remove: function(e, t, n, i, r) {
                    var s, o, a, l, c, u, d, h, p, f, g, m = we.hasData(e) && we.get(e);
                    if (m && (l = m.events)) {
                        for (t = (t || "").match(ve) || [""], c = t.length; c--;)
                            if (a = je.exec(t[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                                for (d = ie.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, h = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length; s--;) u = h[s], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(s, 1), u.selector && h.delegateCount--, d.remove && d.remove.call(e, u));
                                o && !h.length && (d.teardown && d.teardown.call(e, f, m.handle) !== !1 || ie.removeEvent(e, p, m.handle), delete l[p])
                            } else
                ...
                trigger: function(t, n, i, r) {
                    ...
                    if (o = a = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !Oe.test(p + ie.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[ie.expando] ? t : new ie.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ie.makeArray(n, [t]), d = ie.event.special[p] || {}, r || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                        if (!r && !d.noBubble && !ie.isWindow(i)) {
                            for (l = d.delegateType || p, Oe.test(l + p) || (o = o.parentNode); o; o = o.parentNode) h.push(o), a = o;
                            a === (i.ownerDocument || te) && h.push(a.defaultView || a.parentWindow || e)
                        }
                        for (s = 0;
                            (o = h[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : d.bindType || p, u = (we.get(o, "events") || {})[t.type] && we.get(o, "handle"), u && u.apply(o, n), u = c && o[c], u && u.apply && ie.acceptData(o) && (t.result = u.apply(o, n), t.result === !1 && t.preventDefault());
                        return t.type = p, r || t.isDefaultPrevented() || d._default && d._default.apply(h.pop(), n) !== !1 || !ie.acceptData(i) || c && ie.isFunction(i[p]) && !ie.isWindow(i) && (a = i[c], a && (i[c] = null), ie.event.triggered = p, i[p](), ie.event.triggered = void 0, a && (i[c] = a)), t.result
                    }
                },
                dispatch: function(e) {
                    e = ie.event.fix(e);
            ...
            Be.optgroup = Be.option, Be.tbody = Be.tfoot = Be.colgroup = Be.caption = Be.thead, Be.th = Be.td, ie.extend({
                clone: function(e, t, n) {
                    ...
                    return o = w(a, "script"), o.length > 0 && _(o, !l && w(e, "script")), a
                },
                buildFragment: function(e, t, n, i) {
                    for (var r, s, o, a, l, c, u = t.createDocumentFragment(), d = [], h = 0, p = e.length; p > h; h++)
                        if (r = e[h], r || 0 === r)
                            if ("object" === ie.type(r)) ie.merge(d, r.nodeType ? [r] : r);
                            else if (Fe.test(r)) {
                        for (s = s || u.appendChild(t.createElement("div")), o = (Ie.exec(r) || ["", ""])[1].toLowerCase(), a = Be[o] || Be._default, s.innerHTML = a[1] + r.replace(Pe, "<$1></$2>") + a[2], c = a[0]; c--;) s = s.lastChild;
                        ie.merge(d, s.childNodes), s = u.firstChild, s.textContent = ""
                    } else d.push(t.createTextNode(r));
                    for (u.textContent = "", h = 0; r = d[h++];)
                        if ((!i || -1 === ie.inArray(r, i)) && (l = ie.contains(r.ownerDocument, r), s = w(u.appendChild(r), "script"), l && _(s), n))
                ...
                remove: function(e, t) {
                    for (var n, i = e ? ie.filter(e, this) : this, r = 0; null != (n = i[r]); r++) t || 1 !== n.nodeType || ie.cleanData(w(n)), n.parentNode && (t && ie.contains(n.ownerDocument, n) && _(w(n, "script")), n.parentNode.removeChild(n));
                    return this
                },
                empty: function() {
                ...
                html: function(e) {
                    return ye(this, function(e) {
                        ...
                        if ("string" == typeof e && !Me.test(e) && !Be[(Ie.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = e.replace(Pe, "<$1></$2>");
                            try {
                ...
                domManip: function(e, t) {
                    ...
                    var n, i, r, s, o, a, l = 0,
                        ...
                        h = e[0],
                        p = ie.isFunction(h);
                    if (p || c > 1 && "string" == typeof h && !ee.checkClone && Le.test(h)) return this.each(function(n) {
                        var i = u.eq(n);
                    ...
                    if (c && (n = ie.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                        ...
                        if (s)
                            for (a = r[r.length - 1].ownerDocument, ie.map(r, b), l = 0; s > l; l++) o = r[l], Re.test(o.type || "") && !we.access(o, "globalEval") && ie.contains(a, o) && (o.src ? ie._evalUrl && ie._evalUrl(o.src) : ie.globalEval(o.textContent.replace(He, "")))
                    }
                    return this
                }
            }), ie.each({
                ...
                ie.fn[e] = function(e) {
                    for (var n, i = [], r = ie(e), s = r.length - 1, o = 0; s >= o; o++) n = o === s ? this : this.clone(!0), ie(r[o])[t](n), Y.apply(i, n.get());
            ...
            ie.extend({
                ...
                style: function(e, t, n, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var r, s, o, a = ie.camelCase(t),
                            l = e.style;
                        return t = ie.cssProps[a] || (ie.cssProps[a] = A(l, a)), o = ie.cssHooks[t] || ie.cssHooks[a], void 0 === n ? o && "get" in o && void 0 !== (r = o.get(e, !1, i)) ? r : l[t] : (s = typeof n, "string" === s && (r = Ge.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(ie.css(e, t)), s = "number"), void(null != n && n === n && ("number" !== s || ie.cssNumber[a] || (n += "px"), ee.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), o && "set" in o && void 0 === (n = o.set(e, n, i)) || (l[t] = n))))
                    }
                },
                css: function(e, t, n, i) {
                    var r, s, o, a = ie.camelCase(t);
                    return t = ie.cssProps[a] || (ie.cssProps[a] = A(e.style, a)), o = ie.cssHooks[t] || ie.cssHooks[a], o && "get" in o && (r = o.get(e, !0, n)), void 0 === r && (r = S(e, t, i)), "normal" === r && t in Ze && (r = Ze[t]), "" === n || n ? (s = parseFloat(r), n === !0 || ie.isNumeric(s) ? s || 0 : r) : r
                }
            }), ie.each(["height", "width"], function(e, t) {
                ie.cssHooks[t] = {
                    get: function(e, n, i) {
                        return n ? Xe.test(ie.css(e, "display")) && 0 === e.offsetWidth ? ie.swap(e, Qe, function() {
                            return $(e, t, i)
                        }) : $(e, t, i) : void 0
                    },
                    set: function(e, n, i) {
                        var r = i && Ue(e);
                        return T(e, n, i ? N(e, t, i, "border-box" === ie.css(e, "boxSizing", !1, r), r) : 0)
                    }
                }
            }), ie.cssHooks.marginRight = E(ee.reliableMarginRight, function(e, t) {
                return t ? ie.swap(e, {
                ...
                ie.cssHooks[e + t] = {
                    expand: function(n) {
                        for (var i = 0, r = {}, s = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Ee[i] + t] = s[i] || s[i - 2] || s[0];
                        return r
                    }
                }, Ve.test(e) || (ie.cssHooks[e + t].set = T)
            }), ie.fn.extend({
                css: function(e, t) {
            ...
            ie.extend({
                ...
                ajax: function(e, t) {
                    function n(e, t, n, o) {
                        var l, u, v, b, y, x = t;
                        2 !== _ && (_ = 2, a && clearTimeout(a), i = void 0, s = o || "", w.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, n && (b = B(d, w, n)), b = W(d, b, w, l), l ? (d.ifModified && (y = w.getResponseHeader("Last-Modified"), y && (ie.lastModified[r] = y), y = w.getResponseHeader("etag"), y && (ie.etag[r] = y)), 204 === e || "HEAD" === d.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = b.state, u = b.data, v = b.error, l = !v)) : (v = x, (e || !x) && (x = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || x) + "", l ? f.resolveWith(h, [u, x, w]) : f.rejectWith(h, [w, x, v]), w.statusCode(m), m = void 0, c && p.trigger(l ? "ajaxSuccess" : "ajaxError", [w, d, l ? u : v]), g.fireWith(h, [w, x]), c && (p.trigger("ajaxComplete", [w, d]), --ie.active || ie.event.trigger("ajaxStop")))
                    }
                    ...
                    if (f.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || St) + "").replace(gt, "").replace(yt, Et[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ie.trim(d.dataType || "*").toLowerCase().match(ve) || [""], null == d.crossDomain && (l = wt.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === Et[1] && l[2] === Et[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Et[3] || ("http:" === Et[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ie.param(d.data, d.traditional)), q(xt, d, t, w), 2 === _) return w;
                    c = ie.event && d.global, c && 0 === ie.active++ && ie.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !_t.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (ft.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = mt.test(r) ? r.replace(mt, "$1_=" + pt++) : r + (ft.test(r) ? "&" : "?") + "_=" + pt++)), d.ifModified && (ie.lastModified[r] && w.setRequestHeader("If-Modified-Since", ie.lastModified[r]), ie.etag[r] && w.setRequestHeader("If-None-Match", ie.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : d.accepts["*"]);
            ...
            ie.param = function(e, t) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !ie(this).is(":disabled") && Dt.test(this.nodeName) && !$t.test(e) && (this.checked || !Te.test(e))
                    }).map(function(e, t) {
                        var n = ie(this).val();
            ...
            var Ot = 0,
                ...
                It = ie.ajaxSettings.xhr();
            e.attachEvent && e.attachEvent("onunload", function() {
                for (var e in jt) jt[e]()
            }), ee.cors = !!It && "withCredentials" in It, ee.ajax = It = !!It, ie.ajaxTransport(function(e) {
                var t;
                return ee.cors || It && !e.crossDomain ? {
                    send: function(n, i) {
                        var r, s = e.xhr(),
                            o = ++Ot;
                        ...
                        t = function(e) {
                            return function() {
                                t && (delete jt[o], t = s.onload = s.onerror = null, "abort" === e ? s.abort() : "error" === e ? i(s.status, s.statusText) : i(Pt[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                                    text: s.responseText
            ...
            ie.ajaxSetup({
                ...
                var r, s, o, a = t.jsonp !== !1 && (Mt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Mt.test(t.data) && "data");
                return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = ie.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Mt, "$1" + r) : t.jsonp !== !1 && (t.url += (ft.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
                    return o || ie.error(r + " was not called"), o[0]
                }, t.dataTypes[0] = "json", s = e[r], e[r] = function() {
                    o = arguments
                }, i.always(function() {
                    e[r] = s, t[r] && (t.jsonpCallback = n.jsonpCallback, Ft.push(r)), o && ie.isFunction(s) && s(o[0]), o = s = void 0
                }), "script") : void 0
            ...
            ie.offset = {
                ...
                offset: function(e) {
                    ...
                    var t, n, i = this[0],
                        ...
                        s = i && i.ownerDocument;
                    return s ? (t = s.documentElement, ie.contains(t, i) ? (typeof i.getBoundingClientRect !== Ne && (r = i.getBoundingClientRect()), n = V(s), {
                ...
                ie.cssHooks[t] = E(ee.pixelPosition, function(e, n) {
                ...
                return this.length
            }, ie.fn.andSelf = ie.fn.addBack, n(142) && (r = [], !(o = function() {
                return ie
            }.apply(t, r)));
            var qt = e.jQuery,
                Ht = e.$;
            return ie.noConflict = function(t) {
                return e.$ === ie && (e.$ = Ht), t && e.jQuery === ie && (e.jQuery = qt), ie
            }, typeof i === Ne && (e.jQuery = e.$ = ie), ie
        }), ! function(n) {
            r = [o], i = n, s = "function" == typeof i ? i.apply(t, r) : i, !(void 0 !== s && (e.exports = s))
        }(function(e) {
            function t(e) {
        ...
        (function() {
            window.Modernizr = function(e, t, n) {
                ...
                function c(e, t, n) {
                    ...
                    return s(t, "string") || s(t, "undefined") ? a(r, t) : (r = (e + " " + E.join(i + " ") + i).split(" "), l(r, t, n))
                }
                ...
                var d, h, p = "2.8.3",
                    ...
                    F = {}.hasOwnProperty;
                h = s(F, "undefined") || s(F.call, "undefined") ? function(e, t) {
                    ...
                    return i((e + "-webkit- ".split(" ").join(t + e) + C.join(n + e)).slice(0, -e.length)), o(_.backgroundImage, "gradient")
                    ...
                    return !!t.createElementNS && /SVGAnimate/.test(x.call(t.createElementNS(A.svg, "animate")))
                }, T.svgclippaths = function() {
                    return !!t.createElementNS && /SVGClipPath/.test(x.call(t.createElementNS(A.svg, "clipPath")))
                };
                ...
                return f.input || u(), f.addTest = function(e, t) {
                    ...
                    function(e, t) {
                        ...
                        function s(e, n, i) {
                            ...
                            i || (i = r(n));
                            var s;
                            return s = i.cache[e] ? i.cache[e].cloneNode() : f.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e), !s.canHaveChildren || p.test(e) || s.tagUrn ? s : i.frag.appendChild(s)
                        }
                        ...
                        e.html5 = b, l(t)
                    }(this, t), f._version = p, f._prefixes = C, f._domPrefixes = E, f._cssomPrefixes = S, f.mq = P, f.hasEvent = I, f.testProp = function(e) {
                        return a([e])
                    }, f.testAllProps = c, f.testStyles = j, f.prefixed = function(e, t, n) {
        ...
        function(e, t, n, i) {
            ...
            Foundation.libs.clearing = {
                ...
                open: function(t, i, r) {
                    ...
                    function o(t) {
                        var n = e(t);
                        n.css("visibility", "visible"), n.trigger("imageVisible"), l.css("overflow", "hidden"), c.addClass("clearing-blackout"), u.addClass("clearing-container"), d.show(), this.fix_height(r).caption(a.S(".clearing-caption", d), a.S("img", r)).center_and_label(t, p).shift(i, r, function() {
            ...
            var r = function() {},
                s = function(r, s) {
                    ...
                    g.slides = function() {
                        ...
                        var l = function() {
                            var e = function() {
                                v = t, b = !1, n === !0 && (f = g.create_timer(), f.start()), g.update_slide_number(v), m.trigger("after-slide-change.fndtn.orbit", [{
                                    slide_number: v,
                        ...
                        e.hasClass(s.timer_paused_class) ? ("undefined" == typeof f && (f = g.create_timer()), f.start()) : "object" == typeof f && f.stop()
                    }, g.init = function() {
                    ...
                    var o = this,
                        ...
                        m = function(e) {
                            var n = t.location.href === o.entry_location,
                                i = f.scroll_to_content ? o.default_tab_hashes[0] : n ? t.location.hash : "fndtn-" + o.default_tab_hashes[0].replace("#", "");
                ...
                check_validation_and_apply_styles: function(t) {
                    ...
                    for (r.data(this.attr_name(!0) + "-init") || {}; n--;) {
                        ...
                        if (a.getAttribute(this.add_namespace("data-equalto")) && (d = "equalTo"), s = u.is("label") ? u.parent() : u, h && l) m.push(this.valid_radio(a, l));
                            ...
                            _ ? (this.S(a).removeAttr(this.invalid_attr), s.removeClass("error"), f.length > 0 && this.settings.error_labels && f.removeClass(this.settings.error_class).removeAttr("role"), e(a).triggerHandler("valid")) : (this.S(a).attr(this.invalid_attr, ""), s.addClass("error"), f.length > 0 && this.settings.error_labels && f.addClass(this.settings.error_class).attr("role", "alert"), e(a).triggerHandler("invalid"))
                        } else if (m.push(!!(t[n][1].test(c) && g || !l && a.value.length < 1 || e(a).attr("disabled"))), m = [m.every(function(e) {
                                return e
                            })], m[0]) this.S(a).removeAttr(this.invalid_attr), a.setAttribute("aria-invalid", "false"), a.removeAttribute("aria-describedby"), s.removeClass(this.settings.error_class), f.length > 0 && this.settings.error_labels && f.removeClass(this.settings.error_class).removeAttr("role"), e(a).triggerHandler("valid");
                        else {
                            ...
                            var w = s.find("small." + this.settings.error_class, "span." + this.settings.error_class),
                                x = w.length > 0 ? w[0].id : "";
                            x.length > 0 && a.setAttribute("aria-describedby", x), s.addClass(this.settings.error_class), f.length > 0 && this.settings.error_labels && f.addClass(this.settings.error_class).attr("role", "alert"), e(a).triggerHandler("invalid")
                        }
                        i = i.concat(m)
                    }
                    return i
    ...
    151: function(e, t, n) {
        ...
        e.exports = function(e, t) {
            for (var n, r, a, p, f, g, m, v, b = [], _ = t.length; _--;)
                if (n = t[_], r = n.name, f = s.camelize(r.replace(u, "")), c.test(f)) {
                    if (a = s.hyphenate(r), p = e.getAttribute(a), null === p && (a = "data-" + a, p = e.getAttribute(a)), g = {
                            name: r,
                            raw: p,
                            path: f,
                            options: n,
    ...
    152: function(e, t, n) {
        ...
        function a(e, t) {
            ...
            return i && (n = g(e, t)), n || (n = p(e, t)), n || (n = f(e, t)), !n && i && (n = b(e.attributes, t)), n
        }
        ...
        function c(e, t) {
            function n(n) {
                e.type = n, e.def = T(t, "directives", n), e.descriptor = E.parse(e.value)[0]
            }
            var i;
        ...
        function u(e, t) {
            return function(n, i) {
                for (var r, s, o, a = t.cloneNode(!0), l = x.toArray(a.childNodes), c = 0, u = e.length; c < u; c++) r = e[c], s = r.value, r.tag && (o = l[c], r.oneTime ? (s = n.$eval(s), r.html ? x.replace(o, A.parse(s, !0)) : o.data = s) : n._bindDir(r.type, o, r.descriptor, r.def));
                x.replace(i, a)
            }
        }
        ...
        function b(e, t) {
            for (var n, i, r, s, o, a, l = e.length, c = []; l--;) n = e[l], i = n.name, r = n.value, 0 === i.indexOf(k.prefix) ? (o = i.slice(k.prefix.length), a = T(t, "directives", o), "production" !== process.env.NODE_ENV && x.assertAsset(a, "directive", o), a && c.push({
                name: o,
        ...
        t.compile = function(e, t, n) {
            ...
            var n, s, o = t._containerAttrs,
                a = t._replacerAttrs;
            return 11 !== e.nodeType && (t._asComponent ? (o && (n = b(o, t)), a && (s = b(a, t))) : s = b(e.attributes, t)),
                function(e, t) {
                    var o, a = e._context;
                    a && n && (o = i(function() {
                        n(a, t)
    ...
    168: function(e, t, n) {
        ...
        e.exports = {
            bind: function() {
                ...
                e && (this.arg = e[1], this._watcherExp = e[2]), this.id = "__v_repeat_" + ++g, this.start = a.createAnchor("v-repeat-start"), this.end = a.createAnchor("v-repeat-end"), a.replace(this.el, this.end), a.before(this.start, this.end), this.template = a.isTemplate(this.el) ? p.parse(this.el, !0) : this.el, this.idKey = this._checkParam("track-by");
            ...
            resolveComponent: function() {
                this.componentState = v, this.vm._resolveComponent(this.componentId, a.bind(function(e) {
                    this.componentState !== _ && (this.Component = e, this.componentState = b, this.realUpdate(this.pendingData), this.pendingData = null)
                }, this))
            },
            ...
            update: function(e) {
                if ("production" === process.env.NODE_ENV || a.isArray(e) || a.warn("v-repeat pre-converts Objects into Arrays, and v-repeat filters should always return Arrays."), this.componentId) {
                    ...
                    t === m ? (this.pendingData = e, this.resolveComponent()) : t === v ? this.pendingData = e : t === b && this.realUpdate(e)
            ...
            diff: function(e, t) {
                ...
                var _ = 0,
                    y = t.length - b.length;
                for (o = 0, l = t.length; o < l; o++) s = t[o], s._reused || (this.uncacheVm(s), s.$destroy(!1, !0), this.remove(s, _++, y, g));
                var w, x, C, k = 0;
    ...
    187: function(e, t, n) {
        ...
        m.enter = function(e, t) {
            ...
            this.pendingJsCb ? t === p && l(this.el, this.enterClass) : t === p ? (l(this.el, this.enterClass), this.setupCssCb(c, e)) : t === f ? this.setupCssCb(u, e) : e()
        ...
        ! function(e, t, n, i) {
            ...
            e.fn.dropdown = function(r) {
                ...
                return o.each(function(g) {
                    var m, v, b, _, y, w, x, C = e.isPlainObject(r) ? e.extend(!0, {}, e.fn.dropdown.settings, r) : e.extend({}, e.fn.dropdown.settings),
                        k = C.className,
                        S = C.message,
                        E = C.fields,
                        A = C.keys,
                        ...
                        q = F.find(D.input),
                        H = F.find(D.icon),
                        B = F.prev().find(D.text).length > 0 ? F.prev().find(D.text) : F.prev(),
                        W = F.children(D.menu),
                        z = W.find(D.item),
                        V = !1,
                        J = !1,
                    ...
                    x = {
                        ...
                        instantiate: function() {
                            x.verbose("Storing instance of dropdown", x), Y = x, F.data(I, x)
                        },
                        destroy: function() {
                            x.verbose("Destroying previous dropdown", F), x.remove.tabbable(), F.off(P).removeData(I), W.off(P), a.off(b), y && y.disconnect(), w && w.disconnect()
                        },
                        ...
                        create: {
                            ...
                            userChoice: function(t) {
                                ...
                                return !!(t = t || x.get.userValues()) && (t = e.isArray(t) ? t : [t], e.each(t, function(t, o) {
                                    x.get.item(o) === !1 && (s = C.templates.addition(x.add.variables(S.addResult, o)), r = e("<div />").html(s).attr("data-" + T.value, o).attr("data-" + T.text, o).addClass(k.addition).addClass(k.item), n = n === i ? r : n.add(r), x.verbose("Creating user choices for value", o, r))
                                }), n)
                            },
                            ...
                            menu: function() {
                                W = e("<div />").addClass(k.menu).appendTo(F)
                            }
                        },
                        search: function(e) {
                        ...
                        setup: {
                            api: function() {
                                ...
                                x.verbose("First request, initializing API"), F.api(e)
                            },
                            layout: function() {
                                F.is("select") && (x.setup.select(), x.setup.returnedObject()), x.has.menu() || x.create.menu(), x.is.search() && !x.has.search() && (x.verbose("Adding search input"), R = e("<input />").addClass(k.search).prop("autocomplete", "off").insertBefore(L)),
                                    C.allowTab && x.set.tabbable()
                            },
                            select: function() {
                                var t = x.get.selectValues();
                                x.debug("Dropdown initialized on a select", t), F.is("select") && (q = F), q.parent(D.dropdown).length > 0 ? (x.debug("UI dropdown already exists. Creating dropdown menu only"), F = q.closest(D.dropdown), x.has.menu() || x.create.menu(), W = F.children(D.menu), x.setup.menu(t)) : (x.debug("Creating entire dropdown from select"), F = e("<div />").attr("class", q.attr("class")).addClass(k.selection).addClass(k.dropdown).html(j.dropdown(t)).insertBefore(q), q.hasClass(k.multiple) && q.prop("multiple") === !1 && (x.error(O.missingMultiple), q.prop("multiple", !0)), q.is("[multiple]") && x.set.multiple(), q.prop("disabled") && (x.debug("Disabling dropdown"), F.addClass(k.disabled)), q.removeAttr("class").detach().prependTo(F)), x.refresh()
                            },
                            menu: function(e) {
                                W.html(j.menu(e, E)), z = W.find(D.item)
                            },
                            reference: function() {
                                x.debug("Dropdown behavior was called on select, replacing with closest dropdown"), F = F.parent(D.dropdown), x.refresh(), x.setup.returnedObject(), p && (Y = x, x.invoke(h))
                            },
                        ...
                        refreshSelectors: function() {
                            x.verbose("Refreshing selector cache"), L = F.find(D.text), R = F.find(D.search), q = F.find(D.input), H = F.find(D.icon), B = F.prev().find(D.text).length > 0 ? F.prev().find(D.text) : F.prev(), W = F.children(D.menu), z = W.find(D.item)
                        },
                        refreshData: function() {
                            x.verbose("Refreshing cached metadata"), z.removeData(T.text).removeData(T.value), F.removeData(T.defaultText).removeData(T.defaultValue).removeData(T.placeholderText)
                        },
                        toggle: function() {
                        ...
                        show: function(t) {
                            if (t = e.isFunction(t) ? t : function() {}, x.can.show() && !x.is.active()) {
                                ...
                                !x.has.message() || x.has.maxSelections() || x.has.allResultsFiltered() || x.remove.message(), C.onShow.call(X) !== !1 && x.animate.show(function() {
                                    x.can.click() && x.bind.intent(), x.set.visible(), t.call(X)
                                })
                            }
                        },
                        hide: function(t) {
                            t = e.isFunction(t) ? t : function() {}, x.is.active() && (x.debug("Hiding dropdown"), C.onHide.call(X) !== !1 && x.animate.hide(function() {
                                x.remove.visible(), t.call(X)
                            }))
                        },
                        hideOthers: function() {
                            x.verbose("Finding other dropdowns to hide"), o.not(F).has(D.menu + "." + k.visible).dropdown("hide")
                        },
                        hideMenu: function() {
                        ...
                        bind: {
                            ...
                            touchEvents: function() {
                                x.debug("Touch device detected binding additional touch events"), x.is.searchSelection() || x.is.single() && F.on("touchstart" + P, x.event.test.toggle), W.on("touchstart" + P, D.item, x.event.item.mouseenter)
                            },
                            keyboardEvents: function() {
                                x.verbose("Binding keyboard events"), F.on("keydown" + P, x.event.keydown), x.has.search() && F.on(x.get.inputEvent() + P, D.search, x.event.input), x.is.multiple() && a.on("keydown" + b, x.event.document.keydown)
                            },
                            inputEvents: function() {
                                x.verbose("Binding input change events"), F.on("change" + P, D.input, x.event.change)
                            },
                            mouseEvents: function() {
                                x.verbose("Binding mouse events"), x.is.multiple() && F.on("click" + P, D.label, x.event.label.click).on("click" + P, D.remove, x.event.remove.click), x.is.searchSelection() ? (F.on("mousedown" + P, D.menu, x.event.menu.mousedown).on("mouseup" + P, D.menu, x.event.menu.mouseup).on("click" + P, D.icon, x.event.icon.click).on("click" + P, D.search, x.show).on("focus" + P, D.search, x.event.search.focus).on("blur" + P, D.search, x.event.search.blur).on("click" + P, D.text, x.event.text.focus), x.is.multiple() && F.on("click" + P, x.event.click)) : ("click" == C.on ? F.on("click" + P, D.icon, x.event.icon.click).on("click" + P, x.event.test.toggle) : "hover" == C.on ? F.on("mouseenter" + P, x.delay.show).on("mouseleave" + P, x.delay.hide) : F.on(C.on + P, x.toggle), F.on("mousedown" + P, x.event.mousedown).on("mouseup" + P, x.event.mouseup).on("focus" + P, x.event.focus).on("blur" + P, x.event.blur)), W.on("mouseenter" + P, D.item, x.event.item.mouseenter).on("mouseleave" + P, D.item, x.event.item.mouseleave).on("click" + P, D.item, x.event.item.click)
                            },
                            intent: function() {
                        ...
                        filter: function(e) {
                            var t = e !== i ? e : x.get.query(),
                                n = function() {
                                    x.is.multiple() && x.filterActive(), x.select.firstUnfiltered(), x.has.allResultsFiltered() ? C.onNoResults.call(X, t) ? C.allowAdditions || (x.verbose("All items filtered, showing message", t), x.add.message(S.noResults)) : (x.verbose("All items filtered, hiding dropdown", t), x.hideMenu()) : x.remove.message(), C.allowAdditions && x.add.userSuggestion(e), x.is.searchSelection() && x.can.show() && x.is.focusedOnSearch() && x.show()
                                };
                        ...
                        queryRemote: function(t, n) {
                            ...
                            F.api("get request") || x.setup.api(), i = e.extend(!0, {}, i, C.apiSettings), F.api("setting", i).api("query")
                        },
                        ...
                        forceSelection: function() {
                            var e = z.not(k.filtered).filter("." + k.selected).eq(0),
                                t = z.not(k.filtered).filter("." + k.active).eq(0),
                                n = e.length > 0 ? e : t,
                                i = n.size() > 0;
                            if (x.has.query()) {
                        ...
                        event: {
                            ...
                            click: function(t) {
                                var n = e(t.target);
                                n.is(F) && !x.is.focusedOnSearch() && x.focusSearch()
                            },
                            blur: function(e) {
                            ...
                            document: {
                                keydown: function(e) {
                                    ...
                                    if (n) {
                                        ...
                                        if (d && !a && !h) return;
                                        t == A.leftArrow ? !p && !f || a ? a && (e.shiftKey ? x.verbose("Adding previous label to selection") : (x.verbose("Selecting previous label"), i.removeClass(k.active)), c && !l ? r.addClass(k.active) : r.prev(D.siblingLabel).addClass(k.active).end(), e.preventDefault()) : (x.verbose("Selecting previous label"), i.last().addClass(k.active)) : t == A.rightArrow ? (p && !a && i.first().addClass(k.active), a && (e.shiftKey ? x.verbose("Adding next label to selection") : (x.verbose("Selecting next label"), i.removeClass(k.active)), u ? d ? h ? i.removeClass(k.active) : x.focusSearch() : l ? r.next(D.siblingLabel).addClass(k.active) : r.addClass(k.active) : r.next(D.siblingLabel).addClass(k.active), e.preventDefault())) : t == A.deleteKey || t == A.backspace ? a ? (x.verbose("Removing active labels"), u && d && !h && x.focusSearch(), r.last().next(D.siblingLabel).addClass(k.active), x.remove.activeLabels(r), e.preventDefault()) : f && !a && t == A.backspace && (x.verbose("Removing last label on input backspace"), r = i.last().addClass(k.active), x.remove.activeLabels(r)) : r.removeClass(k.active)
                                    }
                                }
                            },
                            keydown: function(e) {
                                ...
                                if (n) {
                                    var i, r, s = z.not(D.unselectable).filter("." + k.selected).eq(0),
                                        ...
                                        g = t == A.delimiter && C.allowAdditions && x.is.multiple();
                                    if (x.is.visible()) {
                                        if ((t == A.enter || g) && (t == A.enter && p && h && !C.allowCategorySelection ? (x.verbose("Pressed enter on unselectable category, opening sub menu"), t = A.rightArrow) : f && (x.verbose("Selecting item from keyboard shortcut", a), x.event.item.click.call(a, e), x.is.searchSelection() && x.remove.searchTerm()), e.preventDefault()), t == A.leftArrow && (r = u[0] !== W[0], r && (x.verbose("Left key pressed, closing sub-menu"), x.animate.hide(!1, u), a.removeClass(k.selected), u.closest(D.item).addClass(k.selected), e.preventDefault())), t == A.rightArrow && h && (x.verbose("Right key pressed, opening sub-menu"), x.animate.show(!1, c), a.removeClass(k.selected), c.find(D.item).eq(0).addClass(k.selected), e.preventDefault()), t == A.upArrow) {
                                            if (i = p && d ? a.prevAll(D.item + ":not(" + D.unselectable + ")").eq(0) : z.eq(0), l.index(i) < 0) return x.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                        ...
                                        if (t == A.downArrow) {
                                            if (i = p && d ? i = a.nextAll(D.item + ":not(" + D.unselectable + ")").eq(0) : z.eq(0), 0 === i.length) return x.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                            x.verbose("Down key pressed, changing active item"), z.removeClass(k.selected), i.addClass(k.selected), x.set.scrollPosition(i), e.preventDefault()
                                        }
                                        t == A.pageUp && (x.scrollPage("up"), e.preventDefault()), t == A.pageDown && (x.scrollPage("down"), e.preventDefault()), t == A.escape && (x.verbose("Escape key pressed, closing dropdown"), x.hide())
                                    } else g && e.preventDefault(), t == A.downArrow && (x.verbose("Down key pressed, showing dropdown"), x.show(), e.preventDefault())
                        ...
                        get: {
                            ...
                            defaultText: function() {
                                return F.data(T.defaultText)
                            },
                            defaultValue: function() {
                                return F.data(T.defaultValue)
                            },
                            placeholderText: function() {
                                return F.data(T.placeholderText) || ""
                            },
                            text: function() {
                                return L.text()
                            },
                            ...
                            value: function() {
                                var t = q.length > 0 ? q.val() : F.data(T.value);
                            ...
                            choiceText: function(t, n) {
                                return n = n !== i ? n : C.preserveHTML, t ? (t.find(D.menu).length > 0 && (x.verbose("Retreiving text of element with sub-menu"), t = t.clone(), t.find(D.menu).remove(), t.find(D.menuIcon).remove()), t.data(T.text) !== i ? t.data(T.text) : n ? e.trim(t.html()) : e.trim(t.text())) : void 0
                            },
                            choiceValue: function(t, n) {
                                return n = n || x.get.choiceText(t), !!t && (t.data(T.value) !== i ? String(t.data(T.value)) : "string" == typeof n ? e.trim(n.toLowerCase()) : String(n))
                            },
                            inputEvent: function() {
                                var e = R[0];
                            ...
                            selectedItem: function() {
                                var e = z.not(D.unselectable).filter("." + k.selected);
                                return e.length > 0 ? e : z.eq(0)
                            },
                            ...
                            item: function(t, n) {
                                var r, s, o = !1;
                                return t = t !== i ? t : x.get.values() !== i ? x.get.values() : x.get.text(), r = s ? t.length > 0 : t !== i && null !== t, s = x.is.multiple() && e.isArray(t), n = "" === t || 0 === t || (n || !1), r && z.each(function() {
                                    var r = e(this),
                        ...
                        check: {
                            maxSelections: function(e) {
                                return !C.maxSelections || (e = e !== i ? e : x.get.selectionCount(), e >= C.maxSelections ? (x.debug("Maximum selection count reached"), C.useLabels && (z.addClass(k.filtered), x.add.message(S.maxSelections)), !0) : (x.verbose("No longer at maximum selection count"), x.remove.message(), x.remove.filteredItem(), x.is.searchSelection() && x.filterItems(), !1))
                            }
                        },
                        restore: {
                            defaults: function() {
                        ...
                        save: {
                            ...
                            defaultValue: function() {
                                var e = x.get.value();
                                x.verbose("Saving default value as", e), F.data(T.defaultValue, e)
                            },
                            defaultText: function() {
                                var e = x.get.text();
                                x.verbose("Saving default text as", e), F.data(T.defaultText, e)
                            },
                            placeholderText: function() {
                                var e;
                                C.placeholder !== !1 && L.hasClass(k.placeholder) && (e = x.get.text(), x.verbose("Saving placeholder text as", e), F.data(T.placeholderText, e))
                            },
                        ...
                        set: {
                            filtered: function() {
                                var e = x.is.multiple(),
                                    ...
                                    o = "" !== i;
                                e && r && (x.verbose("Adjusting input width", s, C.glyphWidth), R.css("width", s)), r || n && o ? (x.verbose("Hiding placeholder text"), L.addClass(k.filtered)) : (!e || n && !o) && (x.verbose("Showing placeholder text"), L.removeClass(k.filtered))
                            },
                            loading: function() {
                                F.addClass(k.loading)
                            },
                            placeholderText: function(e) {
                                e = e || x.get.placeholderText(), x.debug("Setting placeholder text", e), x.set.text(e), L.addClass(k.placeholder)
                            },
                            tabbable: function() {
                                x.has.search() ? (x.debug("Added tabindex to searchable dropdown"), R.val("").attr("tabindex", 0), W.attr("tabindex", -1)) : (x.debug("Added tabindex to dropdown"), F.attr("tabindex") === i && (F.attr("tabindex", 0), W.attr("tabindex", -1)))
                            },
                            ...
                            text: function(e) {
                                "select" !== C.action && ("combo" == C.action ? (x.debug("Changing combo button text", e, B), C.preserveHTML ? B.html(e) : B.text(e)) : (e !== x.get.placeholderText() && L.removeClass(k.placeholder), x.debug("Changing text", e, L), L.removeClass(k.filtered), C.preserveHTML ? L.html(e) : L.text(e)))
                            },
                            selectedLetter: function(t) {
                                var n, i = z.filter("." + k.selected),
                                    r = i.length > 0 && x.has.firstLetter(i, t),
                                    s = !1;
                                r && (n = i.nextAll(z).eq(0), x.has.firstLetter(n, t) && (s = n)), s || z.each(function() {
                            ...
                            value: function(e, t, n) {
                                ...
                                if (r) {
                                    ...
                                    x.is.single() && x.has.selectInput() && x.can.extendSelect() && (x.debug("Adding user option", e), x.add.optionValue(e)), x.debug("Updating input value", e, s), U = !0, q.val(e), C.fireOnInit === !1 && x.is.initialLoad() ? x.debug("Input native change event ignored on initial load") : x.trigger.change(), U = !1
                                } else x.verbose("Storing value in metadata", e, q), e !== s && F.data(T.value, o);
                                C.fireOnInit === !1 && x.is.initialLoad() ? x.verbose("No callback on initial load", C.onChange) : C.onChange.call(X, e, t, n)
                            },
                            active: function() {
                                F.addClass(k.active)
                            },
                            multiple: function() {
                                F.addClass(k.multiple)
                            },
                            visible: function() {
                                F.addClass(k.visible)
                            },
                        ...
                        add: {
                            ...
                            optionValue: function(t) {
                                var n = q.find('option[value="' + t + '"]'),
                                    i = n.length > 0;
                                i || (y && (y.disconnect(), x.verbose("Temporarily disconnecting mutation observer", t)), x.is.single() && (x.verbose("Removing previous user addition"), q.find("option." + k.addition).remove()), e("<option/>").prop("value", t).addClass(k.addition).html(t).appendTo(q), x.verbose("Adding user addition as an <option>", t), y && y.observe(q[0], {
                                    childList: !0,
                                    subtree: !0
                                }))
                            },
                            userSuggestion: function(e) {
                                ...
                                if (!C.useLabels || !x.has.maxSelections()) {
                                    ...
                                    z.removeClass(k.selected), s ? (t = C.templates.addition(x.add.variables(S.addResult, e)), n.html(t).attr("data-" + T.value, e).attr("data-" + T.text, e).removeClass(k.filtered).addClass(k.selected), x.verbose("Replacing user suggestion with new value", n)) : (n = x.create.userChoice(e), n.prependTo(W).addClass(k.selected), x.verbose("Adding item choice to menu corresponding with user choice addition", n))
                                }
                            },
                        ...
                        remove: {
                            ...
                            optionValue: function(e) {
                                var t = q.find('option[value="' + e + '"]'),
                                    n = t.length > 0;
                                n && t.hasClass(k.addition) && (y && (y.disconnect(), x.verbose("Temporarily disconnecting mutation observer", e)), t.remove(), x.verbose("Removing user addition as an <option>", e), y && y.observe(q[0], {
                                    childList: !0,
                                    subtree: !0
                                }))
                            },
                            ...
                            label: function(e, t) {
                                var n = F.find(D.label),
                                    i = n.filter('[data-value="' + e + '"]');
                                x.verbose("Removing label", i), i.remove()
                            },
                            activeLabels: function(e) {
                                e = e || F.find(D.label).filter("." + k.active), x.verbose("Removing active label selections", e), x.remove.labels(e)
                            },
                            labels: function(t) {
                                t = t || F.find(D.label), x.verbose("Removing labels", t), t.each(function() {
                                    var t = e(this),
                                        n = t.data(T.value),
                                        r = n !== i ? String(n) : n,
                                        s = x.is.userValue(r);
                            ...
                            tabbable: function() {
                                x.has.search() ? (x.debug("Searchable dropdown initialized"), R.removeAttr("tabindex"), W.removeAttr("tabindex")) : (x.debug("Simple selection dropdown initialized"), F.removeAttr("tabindex"), W.removeAttr("tabindex"))
                            }
                        },
                        has: {
                            search: function() {
                        ...
                        is: {
                            active: function() {
                                return F.hasClass(k.active)
                            },
                            alreadySetup: function() {
                                return F.is("select") && F.parent(D.dropdown).length > 0 && 0 === F.prev().length
                            },
                            animating: function(e) {
                                return e ? e.transition && e.transition("is animating") : W.transition && W.transition("is animating")
                            },
                            disabled: function() {
                                return F.hasClass(k.disabled)
                            },
                            focused: function() {
                                return n.activeElement === F[0]
                            },
                            ...
                            search: function() {
                                return F.hasClass(k.search)
                            },
                            searchSelection: function() {
                                return x.has.search() && 1 === R.parent(D.dropdown).length
                            },
                            selection: function() {
                                return F.hasClass(k.selection)
                            },
                        ...
                        animate: {
                            show: function(t, n) {
                                ...
                                t = e.isFunction(t) ? t : function() {}, x.verbose("Doing menu show animation", s), x.set.direction(n), r = x.get.transition(n), x.is.selection() && x.set.scrollPosition(x.get.selectedItem(), !0), (x.is.hidden(s) || x.is.animating(s)) && ("none" == r ? (o(), s.transition("show"), t.call(X)) : e.fn.transition !== i && F.transition("is supported") ? s.transition({
                                    animation: r + " in",
                                    debug: C.debug,
                                    verbose: C.verbose,
                                    duration: C.duration,
                            ...
                            hide: function(t, n) {
                                ...
                                t = e.isFunction(t) ? t : function() {}, (x.is.visible(r) || x.is.animating(r)) && (x.verbose("Doing menu hide animation", r), "none" == o ? (s(), r.transition("hide"), t.call(X)) : e.fn.transition !== i && F.transition("is supported") ? r.transition({
                                    animation: o + " out",
                                    duration: C.duration,
                                    debug: C.debug,
                                    verbose: C.verbose,
                                    ...
                                    onStart: s,
                                    onComplete: function() {
                                        "auto" == C.direction && x.remove.upward(n), t.call(X)
                                    }
                        ...
                        invoke: function(t, n, r) {
                            var o, a, l, c = Y;
                            return n = n || f, r = X || r, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), o = t.length - 1, e.each(t, function(n, r) {
        ...
        ! function(e, t, n, i) {
            ...
            e.fn.transition = function() {
                ...
                return t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function(e) {
                    ...
                    var p, f, g, m, v, b, _, y, w, x = e(this),
                        C = this;
                    w = {
                        initialize: function() {
                        ...
                        delay: function(e) {
                            ...
                            o || (o = w.can.transition() ? w.get.direction() : "static"), e = e !== i ? e : p.interval, n = "auto" == p.reverse && o == m.outward, r = n || 1 == p.reverse ? (s.length - t) * p.interval : t * p.interval, w.debug("Delaying animation by", r), setTimeout(w.animate, r)
                        },
                        animate: function(e) {
                        ...
                        queue: function(e) {
                            w.debug("Queueing animation of", e), w.queuing = !0, x.one(b + ".queue" + y, function() {
                        ...
                        set: {
                            ...
                            duration: function(e, t) {
                                t = t || p.duration, t = "number" == typeof t ? t + "ms" : t, (t || 0 === t) && (w.verbose("Setting animation duration", t), x.css({
                        ...
                        start: {
                            animation: function(e) {
                                e = e || w.get.animationClass(), w.debug("Starting tween", e), x.addClass(e).one(b + ".complete" + y, w.complete), p.useFailSafe && w.add.failSafe(), w.set.duration(p.duration), p.onStart.call(C)
                            }
                        },
                        save: {
                            animation: function(e) {
                        ...
                        get: {
                            ...
                            duration: function(e) {
                                return e = e || p.duration, e === !1 && (e = x.css("animation-duration") || 0), "string" == typeof e ? e.indexOf("ms") > -1 ? parseFloat(e) : 1e3 * parseFloat(e) : e
                            },
                        ...
                        is: {
                            ...
                            occurring: function(e) {
                                return e = e || p.animation, e = "." + e.replace(" ", "."), x.filter(e).length > 0
                            },
                            visible: function() {
                                return x.is(":visible")
                            },
                        ...
                        show: function(e) {
                            w.verbose("Showing element", e), w.remove.hidden(), w.set.visible(), w.force.visible(), p.onShow.call(C), p.onComplete.call(C)
                        },
                        toggle: function() {
                        ...
                        performance: {
                            log: function(e) {
                                var t, n, i;
                                p.performance && (t = (new Date).getTime(), i = a || t, n = t - i, a = t, l.push({
                                    Name: e[0],
                                    Arguments: [].slice.call(e, 1) || "",
                                    Element: C,
                                    "Execution Time": n
        ...
        window.jsc || (window.jsc = function() {
            var e = {
                ...
                tryInstallOnElements: function(t, n) {
                    for (var i = new RegExp("(^|\\s)(" + n + ")(\\s*(\\{[^}]*\\})|\\s|$)", "i"), r = 0; r < t.length; r += 1)
                        if (void 0 === t[r].type || "color" != t[r].type.toLowerCase() || !e.isColorAttrSupported) {
                            var s;
                            if (!t[r].jscolor && t[r].className && (s = t[r].className.match(i))) {
                                var o = t[r],
                                    a = null,
                                    l = e.getDataAttr(o, "jscolor");
                                null !== l ? a = l : s[4] && (a = s[4]);
                                var c = {};
                                if (a) try {
                                    c = new Function("return (" + a + ")")()
                                } catch (t) {
                                    e.warn("Error parsing jscolor options: " + t + ":\n" + a)
                                }
                                o.jscolor = new e.jscolor(o, c)
                            }
                        }
                },
                isColorAttrSupported: function() {
                    var e = document.createElement("input");
                    return !(!e.setAttribute || (e.setAttribute("type", "color"), "color" != e.type.toLowerCase()))
                }(),
                ...
                attachGroupEvent: function(t, n, i, r) {
                    e._attachedGroupEvents.hasOwnProperty(t) || (e._attachedGroupEvents[t] = []), e._attachedGroupEvents[t].push([n, i, r]), e.attachEvent(n, i, r)
                },
                detachGroupEvents: function(t) {
                    if (e._attachedGroupEvents.hasOwnProperty(t)) {
                        for (var n = 0; n < e._attachedGroupEvents[t].length; n += 1) {
                            var i = e._attachedGroupEvents[t][n];
                            e.detachEvent(i[0], i[1], i[2])
                        }
                ...
                setClass: function(t, n) {
                    for (var i = e.classNameToList(n), r = 0; r < i.length; r += 1) e.hasClass(t, i[r]) || (t.className += (t.className ? " " : "") + i[r])
                },
                unsetClass: function(t, n) {
                    for (var i = e.classNameToList(n), r = 0; r < i.length; r += 1) {
                    ...
                    return function(e, t, i) {
                        switch (t.toLowerCase()) {
                            case "opacity":
                                ...
                                e.style.opacity = i, e.style.filter = "alpha(opacity=" + r + ")";
                                break;
                            default:
                                e.style[n[t]] = i
                        }
                ...
                getRelPointerPos: function(e) {
                    ...
                    var t = e.target || e.srcElement,
                        ...
                        s = 0,
                        o = 0;
                    return "undefined" != typeof e.changedTouches && e.changedTouches.length ? (s = e.changedTouches[0].clientX, o = e.changedTouches[0].clientY) : "number" == typeof e.clientX && (s = e.clientX, o = e.clientY), i = s - n.left, r = o - n.top, {
                        x: i,
                        y: r
                    }
                },
                ...
                redrawPosition: function() {
                    if (e.picker && e.picker.owner) {
                        var t, n, i = e.picker.owner;
                        i.fixed ? (t = e.getElementPos(i.targetElement, !0), n = [0, 0]) : (t = e.getElementPos(i.targetElement), n = e.getViewPos());
                        var r, s, o, a = e.getElementSize(i.targetElement),
                            l = e.getViewSize(),
                            c = e.getPickerOuterDims(i);
                        ...
                        var u = (a[s] + c[s]) / 2;
                        if (i.smartPosition) var d = [-n[r] + t[r] + c[r] > l[r] && -n[r] + t[r] + a[r] / 2 > l[r] / 2 && t[r] + a[r] - c[r] >= 0 ? t[r] + a[r] - c[r] : t[r], -n[s] + t[s] + a[s] + c[s] - u + u * o > l[s] ? -n[s] + t[s] + a[s] / 2 > l[s] / 2 && t[s] + a[s] - u - u * o >= 0 ? t[s] + a[s] - u - u * o : t[s] + a[s] - u + u * o : t[s] + a[s] - u + u * o >= 0 ? t[s] + a[s] - u + u * o : t[s] + a[s] - u - u * o];
                        else var d = [t[r], t[s] + a[s] - u + u * o];
                        var h = d[r],
                            p = d[s],
                            f = i.fixed ? "fixed" : "absolute",
                            g = (d[0] + c[0] > t[0] || d[0] < t[0] + a[0]) && d[1] + c[1] < t[1] + a[1];
                        e._drawPosition(i, h, p, f, g)
                    }
                },
                _drawPosition: function(t, n, i, r, s) {
                    var o = s ? 0 : t.shadowBlur;
                    e.picker.wrap.style.position = r, e.picker.wrap.style.left = n + "px", e.picker.wrap.style.top = i + "px", e.setBoxShadow(e.picker.boxS, t.shadow ? new e.BoxShadow(0, o, t.shadowBlur, 0, t.shadowColor) : null)
                },
                getPickerDims: function(t) {
                    var n = !!e.getSliderComponent(t),
                        i = [2 * t.insetWidth + 2 * t.padding + t.width + (n ? 2 * t.insetWidth + e.getPadToSliderPadding(t) + t.sliderSize : 0), 2 * t.insetWidth + 2 * t.padding + t.height + (t.closable ? 2 * t.insetWidth + t.padding + t.buttonHeight : 0)];
                    return i
                },
                ...
                onControlPointerStart: function(t, n, i, r) {
                    var s = n._jscInstance;
                    e.preventDefault(t), e.captureTarget(n);
                    var o = function(s, o) {
                        e.attachGroupEvent("drag", s, e._pointerMoveEvent[r], e.onDocumentPointerMove(t, n, i, r, o)), e.attachGroupEvent("drag", s, e._pointerEndEvent[r], e.onDocumentPointerEnd(t, n, i, r))
                    };
                    ...
                    var c = e.getAbsPointerPos(t),
                        u = e.getRelPointerPos(t);
                ...
                onDocumentPointerMove: function(t, n, i, r, s) {
                    return function(t) {
                        var r = n._jscInstance;
                        switch (i) {
                            case "pad":
                                t || (t = window.event), e.setPad(r, t, s[0], s[1]), e.dispatchFineChange(r);
                                break;
                            case "sld":
                                t || (t = window.event), e.setSld(r, t, s[1]), e.dispatchFineChange(r)
                        }
                    }
                },
                onDocumentPointerEnd: function(t, n, i, r) {
                    return function(t) {
                        var i = n._jscInstance;
                        e.detachGroupEvents("drag"), e.releaseTarget(), e.dispatchChange(i)
                    }
                },
                ...
                setPad: function(t, n, i, r) {
                    var s = e.getAbsPointerPos(n),
                        o = i + s.x - e._pointerOrigin.x - t.padding - t.insetWidth,
                        a = r + s.y - e._pointerOrigin.y - t.padding - t.insetWidth,
                        l = o * (360 / (t.width - 1)),
                        c = 100 - a * (100 / (t.height - 1));
                    switch (e.getPadYComponent(t)) {
                        case "s":
                            t.fromHSV(l, c, null, e.leaveSld);
                            break;
                        case "v":
                            t.fromHSV(l, null, c, e.leaveSld)
                    }
                },
                setSld: function(t, n, i) {
                    var r = e.getAbsPointerPos(n),
                        s = i + r.y - e._pointerOrigin.y - t.padding - t.insetWidth,
                    ...
                    if (!e._vmlReady) {
                        ...
                        if (t.namespaces[e._vmlNS] || t.namespaces.add(e._vmlNS, "urn:schemas-microsoft-com:vml"), !t.styleSheets[e._vmlCSS]) {
                            var n = ["shape", "shapetype", "group", "background", "path", "formulas", "handles", "fill", "stroke", "shadow", "textbox", "textpath", "imagedata", "line", "polyline", "curve", "rect", "roundrect", "oval", "arc", "image"],
                                i = t.createStyleSheet();
                            i.owningElement.id = e._vmlCSS;
                            for (var r = 0; r < n.length; r += 1) i.addRule(e._vmlNS + "\\:" + n[r], "behavior:url(#default#VML);")
                        }
                        e._vmlReady = !0
                    }
                },
                createPalette: function() {
                    ...
                    if (e.isCanvasSupported) {
                        var n = document.createElement("canvas"),
                            i = n.getContext("2d"),
                            r = function(e, t, r) {
                                n.width = e, n.height = t, i.clearRect(0, 0, n.width, n.height);
                        ...
                        var a = document.createElement(e._vmlNS + ":rect");
                        ...
                        var c = document.createElement(e._vmlNS + ":rect");
                        c.style.position = "absolute", c.style.left = "-1px", c.style.top = "-1px", c.stroked = !1, c.appendChild(l), s.appendChild(c);
                        var r = function(e, t, n) {
                            switch (s.style.width = e + "px", s.style.height = t + "px", a.style.width = c.style.width = e + 1 + "px", a.style.height = c.style.height = t + 1 + "px", o.color = "#F00", o.color2 = "#F00", n.toLowerCase()) {
                                case "s":
                ...
                createSliderGradient: function() {
                    ...
                    if (e.isCanvasSupported) {
                        ...
                        var r = function(e, t, n, i) {
                            s.style.width = e + "px", s.style.height = t + "px", a.style.width = e + 1 + "px", a.style.height = t + 1 + "px", o.color = n, o.color2 = i
                        };
                        t.elm = s, t.draw = r
                    }
                    return t
                ...
                leaveSld: 8,
                BoxShadow: function() {
                    var e = function(e, t, n, i, r, s) {
                        this.hShadow = e, this.vShadow = t, this.blur = n, this.spread = i, this.color = r, this.inset = !!s
                    };
                ...
                jscolor: function(t, n) {
                    function i(e, t, n) {
                        ...
                        var o = e === i ? 3 + (n - t) / s : t === i ? 5 + (e - n) / s : 1 + (t - e) / s;
                        return [60 * (6 === o ? 0 : o), 100 * (s / r), 100 * r]
                    }

                    function r(e, t, n) {
                        var i = 255 * (n / 100);
                        if (null === e) return [i, i, i];
                        e /= 60, t /= 100;
                        var r = Math.floor(e),
                            s = r % 2 ? e - r : 1 - (e - r),
                            o = i * (1 - t),
                    ...
                    function s() {
                        e.unsetClass(f.targetElement, f.activeClass), e.picker.wrap.parentNode.removeChild(e.picker.wrap), delete e.picker.owner
                    }

                    function o() {
                        function t() {
                            var e = f.insetColor.split(/\s+/),
                                t = e.length < 2 ? e[0] : e[1] + " " + e[0] + " " + e[0] + " " + e[1];
                            n.btn.style.borderColor = t
                        }
                        f._processParentElementsInDOM(), e.picker || (e.picker = {
                            owner: null,
                        ...
                        n.btn.onmousedown = function() {
                            f.hide()
                        }, n.btnT.style.lineHeight = f.buttonHeight + "px", n.btnT.innerHTML = "", n.btnT.appendChild(document.createTextNode(f.closeText)), a(), l(), e.picker.owner && e.picker.owner !== f && e.unsetClass(e.picker.owner.targetElement, f.activeClass), e.picker.owner = f, e.isElementType(g, "body") ? e.redrawPosition() : e._drawPosition(f, 0, 0, "relative", !1), n.wrap.parentNode != g && g.appendChild(n.wrap), e.setClass(f.targetElement, f.activeClass)
                    }

                    function a() {
                        switch (e.getPadYComponent(f)) {
                            case "s":
                                var t = 1;
                                break;
                            case "v":
                        ...
                        var n = Math.round(f.hsv[0] / 360 * (f.width - 1)),
                            i = Math.round((1 - f.hsv[t] / 100) * (f.height - 1)),
                            s = 2 * f.pointerBorderWidth + f.pointerThickness + 2 * f.crossSize,
                            o = -Math.floor(s / 2);
                        switch (e.picker.cross.style.left = n + o + "px", e.picker.cross.style.top = i + o + "px", e.getSliderComponent(f)) {
                            case "s":
                                ...
                                e.picker.sldGrad.draw(f.sliderSize, f.height, c, u);
                                break;
                            case "v":
                    ...
                    function l() {
                        ...
                        if (t) {
                            ...
                            e.picker.sldPtrOB.style.top = i - (2 * f.pointerBorderWidth + f.pointerThickness) - Math.floor(m / 2) + "px"
                        }
                    }

                    function c() {
                        return e.picker && e.picker.owner === f
                    }
                    ...
                    if (this.hide = function() {
                            ...
                            t & e.leaveStyle || this.styleElement && (this.styleElement.style.backgroundImage = "none", this.styleElement.style.backgroundColor = "#" + this.toString(), this.styleElement.style.color = this.isLight() ? "#000" : "#FFF"), t & e.leavePad || !c() || a(), t & e.leaveSld || !c() || l()
                            ...
                            var o = i(null === e ? this.rgb[0] : e, null === t ? this.rgb[1] : t, null === n ? this.rgb[2] : n);
                    ...
                    if (this.valueElement && e.isElementType(this.valueElement, "input")) {
                        var b = function() {
                            f.fromString(f.valueElement.value, e.leaveValue), e.dispatchFineChange(f)
                        };
                        e.attachEvent(this.valueElement, "keyup", b), e.attachEvent(this.valueElement, "input", b), e.attachEvent(this.valueElement, "blur", u), this.valueElement.setAttribute("autocomplete", "off")
                    }
    ...
    1379: function(e, t, n) {
        ...
        e.exports = {
            ...
            ready: function() {
                var e = this;
                s.run(window, e, r), e.initstyle(), i(window).resize(e.initstyle)
            },
            watch: {
                locale: function(e, t) {}
            },
    ...
    1447: function(e, t, n) {
        ...
        e.exports = {
            ...
            attached: function() {
                var e = this;
                i(document).foundation(), i(".ui.dropdown").dropdown(), jsc.init(), i(window).resize();
                var t = r.url + e.activeDevice.FILE,
                    n = i("#viewer-plugin")[0];
                n.postMessage("r;" + t), n.addEventListener("message", function(t) {
                    console.log("message"), console.log(t);
                    var n = JSON.parse(t.data);
                    n.visible = !0, n && "SUCCESS" == n.ERROR.toUpperCase() && (e.selectedLabel.push(n), setTimeout(function() {
                        jsc.init()
                    }, 500))
                }, !1)
            },
            ...
            watch: {
                srchtype: function(e, t) {
                    1 == e ? (i(".labeli-list,.pcontent-list").addClass("active"), this.groupsrch = "") : (i(".labeli-list,.pcontent-list").removeClass("active"), this.paramsrch = "")
                }
            },
            methods: {
                resizeObject: function() {
                    var e = this,
                        t = i("#flight-log").height() - i(".tab-bar").height() - i(".graphic-panel").height();
                    e.viewerHeight = Math.floor(t), i(".log-list-table tbody").css("max-height", i("#flight-log").height() - 228)
                },
                redirect: function(e, t) {
                    utils.directTo(e, t)
                },
                cmdplugin: function(e, t) {
                    try {
                        var n = this,
                            r = i(e.target);
                ...
                readParam: function(e) {
                    var t = this,
                        n = utils.genSeq(t.cmdHistory),
                        r = {
                            SEQ: n,
                            OPERATION: "ReadParam",
                            PARAM_NAME: e
                        };
                    t.cmdHistory[n] = r, i("#viewer-plugin")[0].postMessage("t;" + r.SEQ + ";" + r.OPERATION + ";" + r.PARAM_NAME)
                },
                openContentList: function(e) {
                    e.stopPropagation();
                    var t = i(e.target).parents(".labeli-list"),
                        n = t.next(".pcontent-list");
                    t.toggleClass("active"), n.toggleClass("active")
                },
                colorChange: function(e, t) {
                    ...
                    n.cmdHistory[s] = o, i("#viewer-plugin")[0].postMessage("t;" + o.SEQ + ";ChangeColor;" + o.PARAM_NAME + ";" + o.COLOR), t.COLOR = r.val()
                },
                toggleGraphic: function(e) {
                    var t = this,
                        n = utils.genSeq(t.cmdHistory),
                        r = e.visible ? "Hide" : "Display",
                        s = {
                            SEQ: n,
                            OPERATION: r,
                            PARAM_NAME: e.PARAM_NAME
                        };
                    t.cmdHistory[n] = s, i("#viewer-plugin")[0].postMessage("t;" + s.SEQ + ";" + s.OPERATION + ";" + s.PARAM_NAME), e.visible = !e.visible
                },
                delParam: function(e) {
                    var t = this,
                        n = utils.genSeq(t.cmdHistory),
                    ...
                    t.cmdHistory[n] = s, i("#viewer-plugin")[0].postMessage("t;" + s.SEQ + ";" + s.OPERATION + ";" + s.PARAM_NAME);
                    var o = t.selectedLabel.indexOf(e);
                    t.selectedLabel.splice(o, 1)
                },
                showSettingMask: function() {
                    var e = this;
                    e.showSettings = !0, e.param_list_receive_setting = jQuery.extend(!0, {}, e.param_list_receive), e.uncheckall = !1, e.checkall = !1
                },
                ...
                gocheckall: function() {
                    var e = this;
                    for (var t in e.param_list_receive_setting) e.param_list_receive_setting[t].$set("receive", !0);
                    e.uncheckall = !1, e.checkall = !0
                },
                gouncheckall: function() {
                    var e = this;
                    for (var t in e.param_list_receive_setting) e.param_list_receive_setting[t].$set("receive", !1);
                    e.uncheckall = !0, e.checkall = !1
                },
                toggleme: function(e, t) {
                    var n = this;
                    i(e.target);
                    n.param_list_receive_setting[t].receive = !n.param_list_receive_setting[t].receive, n.uncheckall = !1, n.checkall = !1
                },
                applycheckgrop: function() {
                    var e = this,
                        t = [];
                    e.checkgropstatus = 1;
                    for (var n in e.param_list_receive_setting) e.param_list_receive_setting[n].receive && t.push(n);
                    r.FilterPack({
                        Pack_List: t,
                        onSuccess: function(n) {
                            e.param_list_receive = jQuery.extend(!0, {}, e.param_list_receive_setting), e.hideSettingMask(), console.log(t + " FilterPack successfully!")
                        },
                        onFailure: function(n) {
                            e.checkgropstatus = 0, setTimeout(function() {
                                e.checkgropstatus = 1
                            }, 1e3), console.log(t, " FilterPack failure!", n)
                        },
                        onTimeout: function(e) {
                            console.log(t, " FilterPack timeout!", e)
                        }
                    })
                },
                setrmtab: function(e) {
                ...
                applytimespan: function() {
                    var e = this,
                        t = utils.genSeq(e.cmdHistory),
                        n = "SetTimeWnd",
                        r = {
                            SEQ: t,
                            OPERATION: n,
                            SIZE: e.Settings.xtimespan
                        };
                    e.cmdHistory[t] = r, i("#viewer-plugin")[0].postMessage("t;" + r.SEQ + ";" + r.OPERATION + ";" + r.SIZE), e.hideSettingMask()
                },
                recorder_data_cfg: function(e) {
                    var t = this;
                    if (t.param_list) {
                        for (var n in e.PARAM_LIST) {
                            t.param_list[n] ? t.param_list[n] : [];
                            t.param_list[n] = utils.getUnique(t.param_list[n].concat(e.PARAM_LIST[n])), t.param_list_receive.$set(n, {
                                receive: !1
                            })
                        }
                        console.log(t.param_list)
                    } else {
                        t.param_list = {};
                        for (var n in e.PARAM_LIST) {
                            var i = [];
                            e.PARAM_LIST[n].forEach(function(e, t) {
                                i.push({
                                    name: e
                                })
                            }), t.param_list.$set(n, i), t.param_list_receive.$set(n, {
                                receive: !1
                            })
                        }
                    }
            ...
            events: {
                device_removed: function(e) {},
                device_arrival: function(e) {}
            }
        }
    }
});