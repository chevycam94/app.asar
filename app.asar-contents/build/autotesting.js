    ...
    1138: function(t, e, n) {
        ...
        t.exports = {
            ...
            data: {
                ...
                pushFreq: 10,
                errMsg: {
                    1001: "Set Frequency Request Succeeded",
                    2001: "Set Frequency Request Failed",
                    2002: "Set Frequency Request Timed Out"
                },
                setPushFreqResult: 0,
                obses: "",
                deviceList: {},
            ...
            methods: {
                ...
                initTestingWs: function() {
                    var t = this,
                        e = {
                            ...
                            onclose: function() {
                                console.log("WebSockect is Closed ")
                            },
                            onerror: function() {
                                console.log("WebSockect Error ")
                            },
                ...
                setCaseData: function() {
                    ...
                    e.each(function(e) {
                        ...
                        if (t.executeResult.$delete(a), t.executeMsg.$delete(a), !o) return void t.executeMsg.$set(a, "---------" + s + "Setup Failed, Illegal Parameter");
                        var c = [];
                        i(n).find(".js-input tbody tr:visible").each(function(t) {
                            ...
                            onFailure: function(e) {
                                t.executeMsg.$set(a, "---------" + s + "Setup Failed")
                            },
                            onTimeout: function(e) {
                                t.executeMsg.$set(a, "---------" + s + "Setup Timed Out")
                            }
                        })
                    })
                },
